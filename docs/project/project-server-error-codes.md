...
|常规错误代码|说明|
|:-----|:-----|
|NoError = 0；Success = 0  <br/> |无错误，或者成功。  <br/> |
...
|GeneralInvalidCharacters = 20012  <br/> |有些字符不是有效的。 制表符，除了以下字符不是有效的项目名称: \ /":;< > | , . ' ? * #` <br/> |
...
|(27000-27999)  <br/> |未在 Project Server 中枚举 Active Directory 的其他同步错误。  <br/> |

<a name="pj15_ErrorCodes_Admin"></a>

## <a name="table-6-admin-web-service"></a>表 6. 管理 web 服务
...
|AdminNullProjectProfessionalVersions = 28036  <br/> |一个或多个 Project Professional 版本为 null。  <br/> |
...
## <a name="table-8-assignment"></a>表 8. Assignment
...
|CICOCannotCheckOutVisibilityModeProjectWithMppInDocLib = 10106  <br/> |无法签出包含文档库中的 mpp 文件的可见性模式项目。  <br/> |
...
|CustomFieldInvalidTypeColumnFilledIn = 11704  <br/> |自定义字段类型的列值无效。 请参阅[WCF 的错误代码示例](#pj15_ErrorCodes_WCFExample)中的示例。  <br/> |
...
|CustomFieldRequiredValueNotProvided = 11713  <br/> |不提供一个必填自定义域值。 请参阅[WCF 的错误代码示例](#pj15_ErrorCodes_WCFExample)中的示例。  <br/> |
...
|CustomFieldNewPerRequestLimitExcedeed = 11721  <br/> |超出了新的自定义域的请求限制。 限制为[NEW_CF_PER_REQUEST_LIMIT](https://msdn.microsoft.com/library/Microsoft.Office.Project.Server.Library.CustomField.NEW_CF_PER_REQUEST_LIMIT.aspx)一次请求。  <br/> |
...
|CustomFieldWorkflowCustomFieldBeingReferencedByFormula = 11750  <br/> |公式尝试引用工作流自定义域。  <br/> |
...
|LookupTableMaskSequenceRequiresAnyLength = 11005  <br/> |代码掩码序列需要的_任何_长度。  <br/> |
...
|LookupTableMaskBlankSeparatorInvalidAfterAnyLengthSequence = 11009  <br/> |空分隔符后的_任何_序列长度无效。  <br/> |
...
|LookupTableLanguageParameterInvalidWithXmlFilter = 11080  <br/> |语言参数与查阅表格_xmlFilter_参数无效。  <br/> |
...
表 14 中的错误代码包括项目的项目详细信息页面 (Pdp)、 Exchange 同步、 Project Web App 日程表和数据库错误。 表 14 中的各种错误代码的许多内部使用。
  
> [!NOTE]
> 在 Project Server 2013 中不使用审核错误代码。 

<a name="pj15_ErrorCodes_Miscellaneous"></a>

## <a name="table-14-miscellaneous-error-codes"></a>表 14. 杂项错误代码

|Miscellaneous 的错误代码|说明|
|:-----|:-----|
...
|TimelineViewDataDoesNotExist = 42000  <br/> |Project Web App 中的日程表视图不存在数据。  <br/> |
|DatabaseUndefinedError = 50000  <br/> |未定义数据库。  <br/> |
|DatabaseCannotInsertDuplicateKeyError = 50001  <br/> |数据库无法插入重复键。  <br/> |
...
表 16 中的所有错误代码都是优化器的错误代码，优化器是项目组合分析中使用的一个组件。
...
|OptimizerDepInvalidPosition = 29003  <br/> |[位置](https://msdn.microsoft.com/library/WebSvcPortfolioAnalyses.OptimizerDependencyDataSet.OptimizerDependencyDetailsRow.POSITION.aspx)值无效。  <br/> |
|OptimizerDepDuplicateDependentProjects = 29004  <br/> |[OptimizerDependencyDataSet.OptimizerDependencyDetailsDataTable](https://msdn.microsoft.com/library/WebSvcPortfolioAnalyses.OptimizerDependencyDataSet.OptimizerDependencyDetailsDataTable.aspx)中有重复的项目。  <br/> |
...
|OptimizerNonNormalizedWeights = 29201  <br/> |未标准化[AnalysisDataSet.AnalysisPriorityDataDataTable](https://msdn.microsoft.com/library/WebSvcPortfolioAnalyses.AnalysisDataSet.AnalysisPriorityDataDataTable.aspx)中的**WEIGHT**值。  <br/> |
...
|OptimizerDriverRelationsInvalidInversedValue = 29309  <br/> |[DriverPrioritizationDataSet.DriverRelationsRow](https://msdn.microsoft.com/library/WebSvcDriver.DriverPrioritizationDataSet.DriverRelationsRow.aspx)没有反转值。  <br/> |
|OptimizerCannotCreatePrioritizationUsingInactiveDrivers = 29310  <br/> |没有[DriverPrioritizationDataSet.DriverRelationsRow](https://msdn.microsoft.com/library/WebSvcDriver.DriverPrioritizationDataSet.DriverRelationsRow.aspx)中指定非活动驱动程序。 检查**DRIVER1_UID**和**DRIVER2_UID**属性。  <br/> |
...
|OptimizerCannotAddImpactCFUIDToCFAnalysis = 29618  <br/> |无法添加项目影响自定义域 GUID ([PROJECT_IMPACT_CF_UID](https://msdn.microsoft.com/library/WebSvcPortfolioAnalyses.AnalysisDataSet.AnalysisRow.PROJECT_IMPACT_CF_UID.aspx) ) 的项目组合分析。  <br/> |
...
表 17 中的错误代码都是计划工具的错误代码，计划工具是项目组合分析中使用的一个组件。
...
|PlannerInvalidAnalysisStartDate = 28010  <br/> |[START_DATE](https://msdn.microsoft.com/library/WebSvcPortfolioAnalyses.PlannerSolutionDataSet.SolutionProjectRequirementsByRoleRow.START_DATE.aspx)项目无效。  <br/> |
|PlannerInvalidAnalysisDuration = 28011  <br/> |[持续时间](https://msdn.microsoft.com/library/WebSvcPortfolioAnalyses.PlannerSolutionDataSet.SolutionProjectsRow.DURATION.aspx)的项目组合分析无效。  <br/> |
...
|PlannerNoHiredResource = 28924  <br/> |未根据建议雇用资源。  <br/> |
...
|GeneralDatabaseCommunicationError = 26035  <br/> |存在许多不同的原因，如网络或身份验证问题。  <br/> |
...
|ResourceUnsupportedUserUpdateInSharePointSecurityMode = 2097  <br/> |SharePoint 安全模式中不支持用户创建。  <br/> |
...
|规则错误代码|说明|
|:-----|:-----|
|RulesNameTooLong = 21001  <br/> |审批规则的名称太长。 只能在 Project Web App 中的内部使用。  <br/> |
|RulesDescriptionTooLong = 21002  <br/> |规则说明过长。 只能在 Project Web App 中的内部使用。  <br/> |
|RulesInvalidRuleType = 21003  <br/> |规则类型无效。 只能在 Project Web App 中的内部使用。  <br/> |
|RulesInvalidConditionType = 21004  <br/> |规则的条件类型无效。 只能在 Project Web App 中的内部使用。  <br/> |
|RulesInvalidOperatorType = 21005  <br/> |规则的运算符类型无效。 只能在 Project Web App 中的内部使用。  <br/> |
|RulesInvalidListItemType = 21007  <br/> |规则在列表项类型无效。 只能在 Project Web App 中的内部使用。  <br/> |
|RulesNameInvalidCharacters = 21008  <br/> |有一个或多个字符中的规则名称无效。 只能在 Project Web App 中的内部使用。  <br/> |
|RulesDescriptionInvalidCharacters = 21009  <br/> |有一个或多个规则说明中的字符无效。 只能在 Project Web App 中的内部使用。  <br/> |
|RulesInvalidValueType = 21010  <br/> |在规则的值类型无效。 只能在 Project Web App 中的内部使用。  <br/> |
...
|SecurityCategoryProjectAlreadyHasSecurityProjectCategory = 19099  <br/> |所选类别的列表已具有项目安全类别。  <br/> |
...
|ServerEventRemoteCouldNotReachProxy = 22005  <br/> |远程 Project Web App 无法到达 Project Server 事件管理器的代理。 在 Project Server 代码中，不使用此错误，但它映射到原始的 ULS 事件。  <br/> |
|ServerEventManagerCouldNotReachRemote = 22006  <br/> |Project Server 事件管理器无法到达远程 Project Web App。 在 Project Server 代码中，不使用此错误，但它映射到原始的 ULS 事件。  <br/> |
...
## <a name="table-25-statusing-web-service"></a>表 25。 Statusing web 服务 
...
## <a name="table-26-statusreports"></a>表 26。 StatusReports 
...
|TaskLinkCannotEditExternal = 7047  <br/> |无法编辑指向外部任务的链接。  <br/> |
...
|WorkflowInvalidStageStatusValue = 35112  <br/> |工作流阶段状态的值无效。 设置工作流中的阶段状态时，仅**InProgressRequestSent**， **InProgressRunning**或在[Workflow.StageStatus](https://msdn.microsoft.com/library/Microsoft.Office.Project.Server.Library.Workflow.StageStatus.aspx) **InProgressWaiting**允许值。  <br/> |
...
|EnterpriseProjectTypeInvalidCreatePDPUid = 35206  <br/> |企业项目模板 (EPT) 需要关联的项目详细信息页面 (PDP)，以使用 EPT 创建项目。 如果工作流的 EPT，发生此错误 EPT 验证过程中项目详细信息页面 (PDP) 不*创建*类型时。 其他 PDP 类型都是*普通*编辑的项目和*工作流状态*显示与工作流项目的详细信息。  <br/> |
...
|EnterpriseProjectTypeCannotChangeWorkflowAssociation = 35225  <br/> |项目已具有企业项目类型 (EPT)；无法更改项目的 EPT。  <br/> |
...
|WSSWorkspaceNameContainsIllegalChars = 16412  <br/> |在 SharePoint 项目网站名称的一个或多个字符不是有效的。 以下字符不是有效的项目名称: /": \<\> | , . ' ? \* #  <br/> |
...
|WSSWorkspaceUrlIsNotUnderPrimaryCollection = 18004  <br/> |指定的工作区 url 不是在网站集中与 project server 的此实例相关联。 这是所需的当前权限模式。  <br/> |
|WSSWorkspacesMustBeRestrictedToDefaultCollection = 18005  <br/> |工作区必须限制为当前权限模式中的默认网站集。  <br/> |

<a name="pj15_ErrorCodes_ASMXExample"> </a>

## <a name="error-code-example-for-asmx"></a>ASMX 的错误代码示例

如果您收到异常时调用的 PSI 方法，请获取错误的列表，请将**SoapException**对象传递给[Microsoft.Office.Project.Server.Library.PSClientError](https://msdn.microsoft.com/library/Microsoft.Office.Project.Server.Library.PSClientError.aspx)类构造函数。 然后，您可以使用[GetAllErrors](https://msdn.microsoft.com/library/Microsoft.Office.Project.Server.Library.PSClientError.GetAllErrors.aspx) **PSErrorInfo**数组中存储的错误的信息和枚举的错误，如以下示例所示。 
  
> [!NOTE]
> **PSErrorInfo**对象不包括所有可能需要的信息。 例如，如果您使用**Resource.CheckOutResources**其中一个资源已签出， **PSErrorInfo**显示每个资源的无法签出，但不包括的资源名称或 GUID 的失败的原因。 可以基于 ASMX 的应用程序中获取详细信息，请参阅[CheckOutResources](https://msdn.microsoft.com/library/WebSvcResource.Resource.CheckOutResources.aspx) 。 
...
若要获取的错误列表，如果您收到**System.ServiceModel.FaultException**基于 WCF 的应用程序中调用的 PSI 方法时，您可以从**FaultException**对象中提取**PSClientError**对象。 然后，您可以使用[GetAllErrors](https://msdn.microsoft.com/library/Microsoft.Office.Project.Server.Library.PSClientError.GetAllErrors.aspx) **PSErrorInfo**数组中存储的错误的信息和枚举的错误，如前面的 ASMX 示例所示。 
...
除了**PSClientError**对象中的数据， **FaultException**对象可以包含其他类型的错误，如未能连接到 Project Server。 在上面的示例**GetPSClientError**方法的_errOut_参数显示其他信息。 例如， [QueueCreateProject](https://msdn.microsoft.com/library/WebSvcProject.Project.QueueCreateProject.aspx)方法的**CreateProject4Department**示例代码包括演示如何创建错误**ProjectCustomFields**表中设置属性时的注释。 应用程序运行时， _errOut_参数包括**errinfo**元素和其他数据 （此处进行格式设置从控制台输出）。 
