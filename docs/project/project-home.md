...
- [Project VBA 参考](https://msdn.microsoft.com/library/dn175495.aspx)
  
- [Project 2010](https://msdn.microsoft.com/EN-US/library/ee861523.aspx)
  
### <a name="office-add-ins"></a>Office 加载项
  
- [Project 加载项入门](https://docs.microsoft.com/office/dev/add-ins/quickstarts/project-quickstart )
...
- [适用于 Office 的 VSTO 外接程序](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-ins)
