...
查找开发解决方案和自定义项目的操作方法内容、示例代码、SDK 和 API 文档、VBA 参考、培训和技术文章。
...
- [Project VBA 参考](https://msdn.microsoft.com/en-us/library/dn175495.aspx)
  
- [Project 2010](https://msdn.microsoft.com/EN-US/library/ee861523.aspx)
  
### <a name="office-add-ins"></a>Office 外接程序
  
- [Project 外接程序入门](https://docs.microsoft.com/en-us/office/dev/add-ins/quickstarts/project-quickstart )
...
- [适用于 Office 的 VSTO 外接程序](https://docs.microsoft.com/en-us/office/dev/add-ins/overview/office-add-ins)
