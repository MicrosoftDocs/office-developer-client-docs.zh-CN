...
description: 本主题显示天气信息 XML 架构Outlook架构定义。
...
---
# <a name="schema-map-outlook-weather-information-schema"></a><span data-ttu-id="fef83-103">天气 (Outlook架构) </span><span class="sxs-lookup"><span data-stu-id="fef83-103">Schema map (Outlook Weather Information Schema)</span></span>

<span data-ttu-id="fef83-104">本主题显示天气信息 XML 架构Outlook架构定义。</span><span class="sxs-lookup"><span data-stu-id="fef83-104">This topic shows the schema definition for the Outlook Weather Information XML Schema.</span></span>
