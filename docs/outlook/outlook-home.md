...
- [Outlook VBA 参考](https://docs.microsoft.com/office/vba/api/overview/outlook)
...
- [Outlook 外接程序入门](https://docs.microsoft.com/outlook/add-ins/quick-start?tabs=visual-studio)
  
- [平台概述](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>代码示例
  
- [Office 开发中心上的 Outlook 代码示例](https://developer.microsoft.com/office/gallery/?filterBy=Samples,Outlook)
