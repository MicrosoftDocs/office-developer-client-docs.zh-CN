...
包含 Outlook 便笺文件夹的**EntryID** 。 
  
|||
|:-----|:-----|
|关联的属性：  <br/> |PR_IPM_NOTE_ENTRYID  <br/> |
|标识符:  <br/> |0x36D3  <br/> |
...
2. 如果 * * IMsgStore::GetReceiveFolder * * 是成功，则使用**EntryID**的收件箱和[IMsgStore::OpenEntry](imsgstore-openentry.md)引用打开收件箱并获取**IMAPIFolder**对象的引用。 
