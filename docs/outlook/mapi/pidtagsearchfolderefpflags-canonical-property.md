...
此属性应明确包含**PR_EXTENDED_FOLDER_FLAGS** ([PidTagExtendedFolderFlags](pidtagextendedfolderflags-canonical-property.md)) 属性中的标志, 以及文件夹的字段 b 中的**ExtendedFlags**子属性。 有关文件夹标志的信息, 请参阅[[MS-OXOCFG]](https://msdn.microsoft.com/library/7d466dd5-c156-4da9-9a01-75c78e7e1a67%28Office.15%29.aspx)。
