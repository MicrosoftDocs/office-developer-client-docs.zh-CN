...
设置转换器在 [IConverterSession：：MAPIToMIMEStm](iconvertersession-mapitomimestm.md)中返回 MIME 流的格式。
...
> [in]用于 MIME 流的保存格式。 有关详细信息，请参阅枚举类型 [MIMESAVETYPE](https://msdn.microsoft.com/library/ms715128%28VS.85%29.aspx)。
