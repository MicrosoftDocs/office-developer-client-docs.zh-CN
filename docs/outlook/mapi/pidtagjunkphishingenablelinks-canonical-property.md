...
---
# <a name="pidtagjunkphishingenablelinks-canonical-property"></a>PidTagJunkPhishingEnableLinks 规范属性

  
  
**适用于**： Outlook 
  
表示，如果为 true，则应忽略邮件上的网络钓鱼戳。
  
|||
|:-----|:-----|
|关联的属性：  <br/> |PR_JUNK_PHISHING_ENABLE_LINKS  <br/> |
|标识符:  <br/> |0x6107  <br/> |
