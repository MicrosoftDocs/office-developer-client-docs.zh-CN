...
如果发送客户端已设置传出传输提供程序, 则该提供程序必须始终将此属性保持不变。 如果它未设置, 则传输提供程序应将其设置为邮件的出站副本上的**PR_SENDER_NAME** ([PidTagSenderName](pidtagsendername-canonical-property.md)), 并将其保留在本地副本上。
...
[[毫秒-OXOMSG]](https://msdn.microsoft.com/library/cc433482%28EXCHG.80%29.aspx)
  
> 指定允许用于电子邮件对象的属性和操作。
    
[[毫秒-OXORSS]](https://msdn.microsoft.com/library/cc463884%28EXCHG.80%29.aspx)
