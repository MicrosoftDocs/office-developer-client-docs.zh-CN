...
使用由**pEmsmdbUID**标识的 Exchange 通讯簿打开**entryID** 。 此函数的工作方式类似于[IAddrBook::D etails](iaddrbook-details.md) , 但使用此函数可确保使用预期的 Exchange 通讯簿提供程序打开[IAddrBook:: OpenEntry](iaddrbook-openentry.md) 。 
