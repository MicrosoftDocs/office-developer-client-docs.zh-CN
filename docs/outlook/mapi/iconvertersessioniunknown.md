...
允许 MIME 对象和 MAPI 邮件之间的转换。 在通过 Internet 传输邮件时，这非常有用。
...
|**[SetEncoding](iconvertersession-setencoding.md)** <br/> |初始化在转换期间使用的编码。  <br/> |
| *占位符成员*  <br/> | *不支持或记录。*  <br/> |
...
在使用 **MAPIToMIMEStm** 执行转换之前，先调用 **SetEncoding。** 
