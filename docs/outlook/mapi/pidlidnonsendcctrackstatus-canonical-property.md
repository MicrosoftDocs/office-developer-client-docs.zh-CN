...
包含**dispidNonSendableCC** ([PidLidNonSendableCc](pidlidnonsendablecc-canonical-property.md)) 属性中列出的每个与会者的值。
  
|||
|:-----|:-----|
|相关属性：  <br/> |dispidNonSendCcTrackStatus  <br/> |
|属性集:  <br/> |PSETID_Common  <br/> |
|长 ID (盖子):  <br/> |0x00008544  <br/> |
|数据类型：  <br/> |PT_MV_LONG  <br/> |
|区域：  <br/> |常规邮件  <br/> |
   
## <a name="remarks"></a>注解

仅当设置了**dispidNonSendableCC**属性时, 此属性才是必需的。 此属性中的值的数目必须等于**dispidNonSendableCC**中的值的数目。 此属性中的每个 PT_LONG 值对应于同一索引处**dispidNonSendableCC**属性中的与会者。 
