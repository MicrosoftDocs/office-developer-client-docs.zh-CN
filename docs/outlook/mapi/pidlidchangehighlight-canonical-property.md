...
指定一个位域, 该字段指示如何更改会议对象。
  
|||
|:-----|:-----|
|相关属性：  <br/> |dispidChangeHighlight  <br/> |
|属性集:  <br/> |PSETID_Appointment  <br/> |
|长 ID (盖子):  <br/> |0x00008204  <br/> |
|数据类型：  <br/> |PT_LONG  <br/> |
|区域：  <br/> |会议  <br/> |
   
## <a name="remarks"></a>注解

此属性不是必需的。 可以设置的单个标志在[[OXOCAL]](https://msdn.microsoft.com/library/09861fde-c8e4-4028-9346-e7c214cfdba1%28Office.15%29.aspx)中进行了详细介绍。
