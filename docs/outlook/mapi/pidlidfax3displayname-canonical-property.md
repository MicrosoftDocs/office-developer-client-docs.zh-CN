...
---
# <a name="pidlidfax3displayname-canonical-property"></a>PidLidFax3DisplayName 规范属性
...
|||
|:-----|:-----|
|相关属性：  <br/> |dispidFax3DisplayName  <br/> |
|属性集:  <br/> |PSETID_Address  <br/> |
|长 ID (盖子):  <br/> |0x000080D0  <br/> |
...
> 提供属性集定义定义以及对相关 Exchange Server 协议规范的引用。
