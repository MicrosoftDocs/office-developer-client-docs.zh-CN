...
|长 ID (盖子):  <br/> |0x00008015  <br/> |
|数据类型：  <br/> |PT_BOOLEAN  <br/> |
|区域：  <br/> |Contact  <br/> |
   
## <a name="remarks"></a>注解

如果此属性存在, 并且设置为 true, 则联系人的附件表包含一个附件, 其中**PR_ATTACHMENT_CONTACTPHOTO** ([PidTagAttachmentContactPhoto](pidtagattachmentcontactphoto-canonical-property.md)) 属性设置为 true。
