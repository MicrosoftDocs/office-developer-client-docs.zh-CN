...
---
# <a name="pidtagproofofdeliveryrequested-canonical-property"></a>PidTagProofOfDeliveryRequested 规范属性

  
  
**适用于**： Outlook 2013 |Outlook 2016 
  
如果邮件发件人的特定收件人请求证明传递，则此属性包含 TRUE。
  
|||
|:-----|:-----|
|相关属性：  <br/> |PR_PROOF_OF_DELIVERY_REQUESTED  <br/> |
|标识符：  <br/> |0x0C12  <br/> |
