...
---
# <a name="pidtagstreetaddress-canonical-property"></a>PidTagStreetAddress 规范属性
...
|||
|:-----|:-----|
|相关属性：  <br/> |PR_STREET_ADDRESS、PR_STREET_ADDRESS_A、PR_STREET_ADDRESS_W、PR_BUSINESS_ADDRESS_STREET、PR_BUSINESS_ADDRESS_STREET_A、PR_BUSINESS_ADDRESS_STREET_W  <br/> |
|标识符:  <br/> |0x3A29  <br/> |
...
这些属性可提供收件人的标识和访问信息。 它们由收件人和收件人的组织定义。 
