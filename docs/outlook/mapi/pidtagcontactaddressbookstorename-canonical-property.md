...
---
# <a name="pidtagcontactaddressbookstorename-canonical-property"></a>PidTagContactAddressBookStoreName 规范属性

  
  
**适用于**：Outlook 2013 | Outlook 2016 
  
包含显示名称通讯簿提供程序关联的存储的名称。 
...
这些属性位于联系人通讯簿容器上，而列位于联系人通讯簿容器的表中。
