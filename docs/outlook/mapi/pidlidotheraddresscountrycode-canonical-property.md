...
---
# <a name="pidlidotheraddresscountrycode-canonical-property"></a>PidLidOtherAddressCountryCode 规范属性

  
  
**适用于**：Outlook 2013 | Outlook 2016 
  
指定联系人的其他地址的国家/地区代码部分。
  
|||
|:-----|:-----|
|相关属性：  <br/> |dispidOtherAddressCountryCode  <br/> |
|属性集:  <br/> |PSETID_Address  <br/> |
|长 ID (盖子):  <br/> |0x000080DC  <br/> |
