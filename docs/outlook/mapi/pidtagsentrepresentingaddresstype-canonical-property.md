...
---
# <a name="pidtagsentrepresentingaddresstype-canonical-property"></a>PidTagSentRepresentingAddressType 规范属性
...
|||
|:-----|:-----|
|相关属性：  <br/> |PR_SENT_REPRESENTING_ADDRTYPE，PR_SENT_REPRESENTING_ADDRTYPE_A，PR_SENT_REPRESENTING_ADDRTYPE_W  <br/> |
|标识符：  <br/> |0x0064  <br/> |
...
传出的传输提供程序必须始终保持不变，如果已发送的客户端设置此属性。 如果未设置，传输提供程序应出站邮件，副本上将其设置为**PR_SENDER_ADDRTYPE** ([PidTagSenderAddressType](pidtagsenderaddresstype-canonical-property.md)) 属性，而保持它未设置的本地副本。
