...
如果发送客户端已设置此属性，则传出传输提供程序必须始终保持该属性不变。 如果未设置，传输提供程序应将其设置为邮件的出站副本上的 **PR_SENDER_ADDRTYPE** ([PidTagSenderAddressType](pidtagsenderaddresstype-canonical-property.md)) 属性，并保留在本地副本上未设置。
