...
---
# <a name="pidtagbusinessfaxnumber-canonical-property"></a>PidTagBusinessFaxNumber 规范属性
...
|||
|:-----|:-----|
|相关属性：  <br/> |PR_BUSINESS_FAX_NUMBER、PR_BUSINESS_FAX_NUMBER_A、PR_BUSINESS_FAX_NUMBER_W  <br/> |
|标识符:  <br/> |0x3A24  <br/> |
