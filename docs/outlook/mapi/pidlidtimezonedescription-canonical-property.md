...
|||
|:-----|:-----|
|相关属性：  <br/> |dispidTimeZoneDesc  <br/> |
|属性集:  <br/> |PSETID_Appointment  <br/> |
|长 ID (盖子):  <br/> |0x00008234  <br/> |
|数据类型：  <br/> |PT_UNICODE  <br/> |
|区域：  <br/> |日历  <br/> |
   
## <a name="remarks"></a>注解

此属性指定由**dispidTimeZoneStruct** ([PidLidTimeZoneStruct](pidlidtimezonestruct-canonical-property.md)) 属性中的数据表示的时区的可读说明。
