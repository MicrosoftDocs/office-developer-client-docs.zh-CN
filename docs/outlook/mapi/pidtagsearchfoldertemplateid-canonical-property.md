...
"搜索文件夹" 条件由模板指定。 定义搜索文件夹的消息中的此属性标识其对应的模板。 除了定义搜索条件之外, 模板还定义要从搜索中排除的文件夹, 定义要从搜索中排除的项, 并指定**PR_WB_SF_STORAGE_TYPE** ([PidTagSearchFolderStorageType](pidtagsearchfolderstoragetype-canonical-property.md)) 的值。
