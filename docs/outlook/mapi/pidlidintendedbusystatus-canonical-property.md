...
指定在发送会议请求或会议更新时, 在组织者的日历中的会议上的**dispidBusyStatus** ([PidLidBusyStatus](pidlidbusystatus-canonical-property.md)) 属性的值。
  
|||
|:-----|:-----|
|相关属性：  <br/> |dispidIntendedBusyStatus  <br/> |
|属性集:  <br/> |PSETID_Appointment  <br/> |
|长 ID (盖子):  <br/> |0x00008224  <br/> |
|数据类型：  <br/> |PT_LONG  <br/> |
|区域：  <br/> |会议  <br/> |
   
## <a name="remarks"></a>注解

此属性的允许值与属性**dispidBusyStatus**的允许值相同。
