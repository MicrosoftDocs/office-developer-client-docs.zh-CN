...
指示请求回执的邮件的报告收件人的电子邮件地址。
  
|||
|:-----|:-----|
|相关属性：  <br/> |PR_REPORT_DISPOSITION_TO_EMAIL_ADDRESSES、PR_REPORT_DISPOSITION_TO_EMAIL_ADDRESSES_A、PR_REPORT_DISPOSITION_TO_EMAIL_ADDRESSES_W  <br/> |
|标识符:  <br/> |0x0084  <br/> |
