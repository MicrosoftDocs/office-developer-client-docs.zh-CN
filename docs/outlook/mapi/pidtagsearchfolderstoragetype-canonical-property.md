...
包含指定二进制大型对象 (BLOB) [PidTagSearchFolderDefinition](pidtagsearchfolderdefinition-canonical-property.md) PR_WB_SF_DEFINITION (属性) 标记。 
...
标志的定义在 [[MS-OXOSRCH] 中指定](https://msdn.microsoft.com/library/c72e49b8-78c7-4483-ad65-e46e9133673b%28Office.15%29.aspx)。 搜索PR_WB_SF_STORAGE_TYPE 。
