...
包含指定在**PR_WB_SF_DEFINITION** ([PidTagSearchFolderDefinition](pidtagsearchfolderdefinition-canonical-property.md)) 属性中出现的二进制大型对象 (BLOB) 数据的标志。
...
这些标志的定义在[[OXOSRCH]](https://msdn.microsoft.com/library/c72e49b8-78c7-4483-ad65-e46e9133673b%28Office.15%29.aspx)中指定。 搜索**PR_WB_SF_STORAGE_TYPE**。
