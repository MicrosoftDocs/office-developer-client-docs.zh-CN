...
|LONG ID (的一) ：  <br/> |0x0000823D  <br/> |
|数据类型：  <br/> |PT_BINARY  <br/> |
|区域：  <br/> |会议  <br/> |
   
## <a name="remarks"></a>备注

此属性不是必需的，但应进行设置。 其格式在 [[MS-OXOCAL] 中详细说明](https://msdn.microsoft.com/library/09861fde-c8e4-4028-9346-e7c214cfdba1%28Office.15%29.aspx)。
