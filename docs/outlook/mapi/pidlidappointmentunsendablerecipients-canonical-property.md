...
包含 unsendable 与会者的列表。
  
|||
|:-----|:-----|
|相关属性：  <br/> |dispidApptUnsendableRecips  <br/> |
|属性集:  <br/> |PSETID_Appointment  <br/> |
|长 ID (盖子):  <br/> |0x0000823D  <br/> |
|数据类型：  <br/> |PT_BINARY  <br/> |
|区域：  <br/> |会议  <br/> |
   
## <a name="remarks"></a>注解

此属性不是必需的, 但应进行设置。 它的格式在[[OXOCAL]](https://msdn.microsoft.com/library/09861fde-c8e4-4028-9346-e7c214cfdba1%28Office.15%29.aspx)中进行了详细介绍。
