...
此属性仅在[PidTagScheduleInfoAutoAcceptAppointments](pidtagscheduleinfoautoacceptappointments-canonical-property.md) PR_SCHDINFO_AUTO_ACCEPT_APPTS (值为 TRUE 时) 才有意义。  缺少此属性指示必须接受定期会议。 这不是必需的属性。
