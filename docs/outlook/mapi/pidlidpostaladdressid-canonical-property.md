...
如果存在此参数，此属性必须具有下表中或在[[MS OXOCNTC]](https://msdn.microsoft.com/library/9b636532-9150-4836-9635-9c9b756c9ccf%28Office.15%29.aspx)中指定的值之一。 如果不设置，应用程序应假定的值是"0x00000000"。
