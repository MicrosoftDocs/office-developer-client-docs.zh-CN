...
此属性的格式、计算和约束与 **PR_SCHDINFO_FREEBUSY_TENTATIVE** PR_SCHDINFO_FREEBUSY_TENTATIVE ([PidTagScheduleInfoFreeBusyTentative](pidtagscheduleinfofreebusytentative-canonical-property.md)) 但指在关联日历上标记为 OOF 的约会。
