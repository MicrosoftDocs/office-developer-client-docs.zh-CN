...
包含 "闲/忙" 状态设置为 "OOF" 的时间。
  
|||
|:-----|:-----|
|相关属性：  <br/> |PR_SCHDINFO_FREEBUSY_OOF  <br/> |
|标识符:  <br/> |0x6856  <br/> |
...
此属性的格式、计算和约束与**PR_SCHDINFO_FREEBUSY_TENTATIVE** ([PidTagScheduleInfoFreeBusyTentative](pidtagscheduleinfofreebusytentative-canonical-property.md)) 的格式、计算和约束相同, 但引用在关联的日历上标记为 OOF 的约会。
