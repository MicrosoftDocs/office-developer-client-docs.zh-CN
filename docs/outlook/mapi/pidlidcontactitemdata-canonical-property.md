...
|LONG ID (的一) ：  <br/> |0x00008007  <br/> |
|数据类型：  <br/> |PT_MV_LONG  <br/> |
|区域：  <br/> |联系人  <br/> |
   
## <a name="remarks"></a>备注

如果存在，则属性必须具有六个条目，每个条目对应于应用程序用户界面中的可见字段。
  
|**多值属性中从 1 到 1 的索引**|**值必须是下列值之一**|**说明**|
|:-----|:-----|:-----|
|1  <br/> |0x00000001  <br/> |应用程序应显示联系人的住宅地址。  <br/> |
|1  <br/> |0x00000002 或 0x00000000  <br/> |应用程序应显示联系人的工作。  <br/> |
|1  <br/> |0x00000003  <br/> |应用程序应显示联系人的其他地址。  <br/> |
|2  <br/> |0x00008080  <br/> |应用程序应显示 Email1。  <br/> |
|2  <br/> |0x00008090  <br/> |应用程序应显示 Email2。  <br/> |
|2  <br/> |0x000080A0  <br/> |应用程序应显示 Email3。  <br/> |
