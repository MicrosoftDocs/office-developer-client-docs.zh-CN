...
因为它处理基础 OLE 对象，MAPI 需要使用 OLE 内存分配。 有关存储的结构化的 OLE 对象和 OLE 内存分配的详细信息，请参阅[OLE 和数据传输](http://msdn.microsoft.com/library/d4a57956-37ba-44ca-8efc-bf617ad5e77b.aspx)。 
