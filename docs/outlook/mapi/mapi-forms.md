...
在之前阅读本节，您应熟悉的[MAPI 表单概述](mapi-forms-overview.md)主题中的材料。 
  
> [!NOTE]
> MAPI 表单体系结构基于上组件对象模型 (COM)，因为开发表单服务器应用程序需要 COM 编程的知识。 有关 COM 的详细信息，请参阅 Windows SDK 中的 COM 和 ActiveX 对象服务一节。 
