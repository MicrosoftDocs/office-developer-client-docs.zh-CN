...
---
# <a name="pidtaghomeaddresscountry-canonical-property"></a>PidTagHomeAddressCountry 规范属性
...
|||
|:-----|:-----|
|相关属性：  <br/> |PR_HOME_ADDRESS_COUNTRY、PR_HOME_ADDRESS_COUNTRY_A、PR_HOME_ADDRESS_COUNTRY_W  <br/> |
|标识符:  <br/> |0x3A5A  <br/> |
