...
指定与共享提供程序相关且由 **dispidSharingProviderGuid** ([PidLidSharingProviderGuid](pidlidsharingproviderguid-canonical-property.md) 属性) URL。 这是共享邮件的属性。
  
|||
|:-----|:-----|
|相关属性：  <br/> |dispidSharingProviderUrl  <br/> |
|属性集：  <br/> |PSETID_Sharing  <br/> |
|LONG ID (的一) ：  <br/> |0x00008A03  <br/> |
|数据类型：  <br/> |PT_UNICODE  <br/> |
|区域：  <br/> |共享  <br/> |
   
## <a name="remarks"></a>备注

此属性通常用于提供有关共享提供程序详细信息，但应忽略。
