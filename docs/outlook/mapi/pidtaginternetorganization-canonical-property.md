...
---
# <a name="pidtaginternetorganization-canonical-property"></a>PidTagInternetOrganization 规范属性
...
|||
|:-----|:-----|
|相关属性：  <br/> |PR_INTERNET_ORGANIZATION、PR_INTERNET_ORGANIZATION_A、PR_INTERNET_ORGANIZATION_W  <br/> |
|标识符:  <br/> |0x1037  <br/> |
