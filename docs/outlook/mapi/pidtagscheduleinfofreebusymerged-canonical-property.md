...
此属性中不包含忙/闲类型暂定事件。 此属性的格式、计算和限制与 **PR_SCHDINFO_FREEBUSY_TENTATIVE** ([PidTagScheduleInfoFreeBusyTentative](pidtagscheduleinfofreebusytentative-canonical-property.md)) 相同，但指在关联的日历上标记为 OOF 或忙碌的约会。
