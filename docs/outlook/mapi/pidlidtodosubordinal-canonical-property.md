...
当 **dispidToDoOrdinalDate** ([PidLidToDoOrdinalDate](pidlidtodoordinaldate-canonical-property.md)) 属性对对象进行排序时充当关系断开器，并产生等价的结果。
  
|||
|:-----|:-----|
|相关属性：  <br/> |dispidToDoSubOrdinal  <br/> |
|属性集：  <br/> |PSETID_Common  <br/> |
|LONG ID (的一) ：  <br/> |0x000085A1  <br/> |
|数据类型：  <br/> |PT_UNICODE  <br/> |
|区域：  <br/> |任务  <br/> |
   
## <a name="remarks"></a>备注

如果使用此属性，则必须按字典顺序对此属性进行排序。 字符串的组件字符必须仅包含数字 0 到 9。 此属性最初应设置为"5555555"。 此属性的长度不得超过 254 个字符， (以 NULL 字符作为) 。
