...
指示要从会议请求生成的会议的**PR_MESSAGE_CLASS** ([PidTagMessageClass](pidtagmessageclass-canonical-property.md)) 属性。
  
|||
|:-----|:-----|
|相关属性：  <br/> |dispidApptMessageClass  <br/> |
|属性集:  <br/> |PSETID_Meeting  <br/> |
|长 ID (盖子):  <br/> |0x00000024  <br/> |
|数据类型：  <br/> |PT_TSTRING  <br/> |
|区域：  <br/> |会议  <br/> |
   
## <a name="remarks"></a>注解

此属性的值必须是 "IPM。约会 "或以" IPM. "作为前缀。约会 "。 此属性不是必需的。
