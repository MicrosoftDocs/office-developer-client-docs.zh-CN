...
指定由 **dispidSharingProviderGuid** ([PidLidSharingProviderGuid](pidlidsharingproviderguid-canonical-property.md)) 标识的共享提供程序的用户可显示名称。 这是共享邮件的属性。
  
|||
|:-----|:-----|
|相关属性：  <br/> |dispidSharingProviderName  <br/> |
|属性集：  <br/> |PSETID_Sharing  <br/> |
|LONG ID (的一) ：  <br/> |0x00008A02  <br/> |
