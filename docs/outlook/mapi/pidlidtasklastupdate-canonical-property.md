...
指示协调世界时 (UTC) 以及对任务进行的最新更改的日期，由 **dispidTaskHistory** ([PidLidTaskHistory](pidlidtasklastupdate-canonical-property.md)) 属性指示。
  
|||
|:-----|:-----|
|相关属性：  <br/> |dispidTaskLastUpdate  <br/> |
|属性集：  <br/> |PSETID_Task  <br/> |
|LONG ID (的一) ：  <br/> |0x00008115  <br/> |
