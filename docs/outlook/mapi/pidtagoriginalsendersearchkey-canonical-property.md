...
包含邮件第一版的发件人的搜索关键字, 即邮件转发或答复前的邮件。
...
此属性是邮件原始发件人的地址属性之一。 首次提交邮件时, 客户端应用程序应将此属性设置为**PR_SENDER_SEARCH_KEY** ([PidTagSenderSearchKey](pidtagsendersearchkey-canonical-property.md)) 属性的值。 转发或答复邮件时, 它永远不会更改。
