...
包含联系人的组织 id 号, 例如雇员 id 号。
  
|||
|:-----|:-----|
|相关属性：  <br/> |PR_ORGANIZATIONAL_ID_NUMBER、PR_ORGANIZATIONAL_ID_NUMBER_A、PR_ORGANIZATIONAL_ID_NUMBER_W  <br/> |
|标识符:  <br/> |0x3A10  <br/> |
