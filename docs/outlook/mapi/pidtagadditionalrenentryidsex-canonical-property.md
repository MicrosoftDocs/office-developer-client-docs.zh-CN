...
|:-----|:-----|:-----|:-----|
|RSF_ELID_HEADER  <br/> |0x0002  <br/> |0x0004  <br/> |指示此块**ElementData**字段包含 DWORD 标头值。 如何解释此值取决于的块**PersistID**类型。  <br/> 对于[[MS OXOSFLD]](https://msdn.microsoft.com/library/a60e9c16-2ba8-424b-b60c-385a8a2837cb.aspx)中指定的所有**PersistID**类型，此值为零。  <br/> |
