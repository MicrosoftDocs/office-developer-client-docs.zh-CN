...
---
# <a name="pidlidattendeecriticalchange-canonical-property"></a>PidLidAttendeeCriticalChange 规范属性
...
|||
|:-----|:-----|
|相关属性：  <br/> |LID_ATTENDEE_CRITICAL_CHANGE  <br/> |
|属性进行设置：  <br/> |PSETID_Meeting  <br/> |
|长 ID （盖）：  <br/> |0x00000001  <br/> |
