...
|||
|:-----|:-----|
|相关属性：  <br/> |PR_ATTACHMENT_LINKID  <br/> |
|标识符:  <br/> |0x7FFA  <br/> |
|数据类型：  <br/> |PT_LONG  <br/> |
|区域：  <br/> |邮件附件  <br/> |
...
必须为 0, 除非由扩展邮件和附件对象协议的其他协议替代[[OXCMSG]](https://msdn.microsoft.com/library/daa9120f-f325-4afb-a738-28f91049ab3c%28Office.15%29.aspx)中所述。
