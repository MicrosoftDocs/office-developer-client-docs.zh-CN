...
1. 调用邮件的[IMAPIProp:: GetProps](imapiprop-getprops.md)方法以检索其**PR_MESSAGE_CLASS** ([PidTagMessageClass](pidtagmessageclass-canonical-property.md)) 属性。
    
2. 调用[MAPIOpenFormMgr](mapiopenformmgr.md)以检索**IMAPIFormMgr**接口指针。 在_pSession_参数中传递**IMAPISession**指针。 
