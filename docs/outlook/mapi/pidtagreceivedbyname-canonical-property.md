...
---
# <a name="pidtagreceivedbyname-canonical-property"></a>PidTagReceivedByName 规范属性
...
|||
|:-----|:-----|
|相关属性：  <br/> |PR_RECEIVED_BY_NAME，PR_RECEIVED_BY_NAME_A，PR_RECEIVED_BY_NAME_W  <br/> |
|标识符：  <br/> |0x0040  <br/> |
...
这些属性是个收到邮件的邮件用户的地址属性的示例。 它们必须由传入传输提供程序设置。
