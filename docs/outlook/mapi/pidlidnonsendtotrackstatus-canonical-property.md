...
包含 **dispidNonSendableTo** ([PidLidNonSendableTo](pidlidnonsendableto-canonical-property.md)) 值。
  
|||
|:-----|:-----|
|相关属性：  <br/> |dispidNonSendToTrackStatus  <br/> |
|属性集：  <br/> |PSETID_Common  <br/> |
|LONG ID (的一) ：  <br/> |0x00008543  <br/> |
|数据类型：  <br/> |PT_MV_LONG  <br/> |
|区域：  <br/> |常规消息  <br/> |
   
## <a name="remarks"></a>备注

此属性仅在设置 **dispidNonSendableTo** 属性时是必需的。 此属性中的值数必须等于 **dispidNonSendableTo 中的值数**。 此属性PT_LONG值对应于同一索引 **的 dispidNonSendableTo** 属性中的 attendee。 
