...
以下属性的所有邮件的收件人，通常有。 **PR_EMAIL_ADDRESS**和**PR_SEARCH_KEY**是可选的;所有其他属性都是必需的。 
  
**表标题**

|**属性**|**说明**|
|:-----|:-----|
|**PR_ADDRTYPE**([PidTagAddressType](pidtagaddresstype-canonical-property.md))  <br/> |包含消息的用户的电子邮件地址类型，如 SMTP。  <br/> |
...
|**PR_EMAIL_ADDRESS**([PidTagEmailAddress](pidtagemailaddress-canonical-property.md))  <br/> |包含消息的用户的电子邮件地址。  <br/> |
