...
将此属性传递给 [对象的 IMAPIProp：：OpenProperty](imapiprop-openproperty.md) 方法将返回允许创建显示表的 [IMAPITable](imapitableiunknown.md) 接口。 MAPI 使用此表显示通讯簿对象的属性表以响应 [IAddrBook：:D etails](iaddrbook-details.md) 调用。 
