...
包含邮件收件人可用于到达发件人的电话号码。 
  
|||
|:-----|:-----|
|相关属性：  <br/> |PR_CALLBACK_TELEPHONE_NUMBER、PR_CALLBACK_TELEPHONE_NUMBER_A、PR_CALLBACK_TELEPHONE_NUMBER_W  <br/> |
|标识符:  <br/> |0x3A02  <br/> |
...
这些属性是提供有关收件人的标识和访问信息的属性示例。 它们由收件人和收件人的组织定义。 
