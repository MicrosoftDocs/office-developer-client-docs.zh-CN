...
如果在 logon 对象上设置了此属性, 客户端应在此属性指定的值下保留**PR_EXTENDED_RULE_MSG_CONDITION** ([PidTagExtendedRuleMessageCondition](pidtagextendedrulemessagecondition-canonical-property.md)) 属性的大小。 相反, 如果客户端尝试设置过大的二进制属性, 服务器将返回一个错误。
  
有关扩展规则的详细信息, 请参阅[[MS-OXORULE]](https://msdn.microsoft.com/library/70ac9436-501e-43e2-9163-20d2b546b886%28Office.15%29.aspx)。
