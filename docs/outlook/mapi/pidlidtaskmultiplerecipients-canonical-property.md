...
|LONG ID (的一) ：  <br/> |0x00008120  <br/> |
|数据类型：  <br/> |PT_LONG  <br/> |
|区域：  <br/> |任务  <br/> |
   
## <a name="remarks"></a>备注

如果设置此属性，则必须将此属性设置为以下零个或多个值的位 **OR** 运算。 
  
|**名称**|**值**|**说明**|
|:-----|:-----|:-----|
|发件箱  <br/> |0x00000001  <br/> |该任务有多个主收件人。  <br/> |
|接收时间  <br/> |0x00000002  <br/> |尽管"已发送"提示不存在，但客户端检测到该任务有多个主收件人。  <br/> |
|Reserved  <br/> |0x00000004  <br/> |保留此值。  <br/> |
