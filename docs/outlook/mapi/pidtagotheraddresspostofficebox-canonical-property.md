...
---
# <a name="pidtagotheraddresspostofficebox-canonical-property"></a>PidTagOtherAddressPostOfficeBox 规范属性

  
  
**适用于**：Outlook 2013 | Outlook 2016 
  
包含联系人的其他地址的邮局的 "box" 框。
  
|||
|:-----|:-----|
|相关属性：  <br/> |PR_OTHER_ADDRESS_POST_OFFICE_BOX、PR_OTHER_ADDRESS_POST_OFFICE_BOX_A、PR_OTHER_ADDRESS_POST_OFFICE_BOX_W  <br/> |
|标识符:  <br/> |0x3A64  <br/> |
