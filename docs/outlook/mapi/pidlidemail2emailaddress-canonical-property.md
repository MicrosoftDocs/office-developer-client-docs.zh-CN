...
---
# <a name="pidlidemail2emailaddress-canonical-property"></a>PidLidEmail2EmailAddress 规范属性
...
|||
|:-----|:-----|
|相关属性：  <br/> |dispidEmail2EmailAddress  <br/> |
|属性集：  <br/> |PSETID_Address  <br/> |
|LONG ID (的一) ：  <br/> |0x00008093  <br/> |
|数据类型：  <br/> |PT_UNICODE  <br/> |
|区域：  <br/> |联系人  <br/> |
   
## <a name="remarks"></a>备注

此属性的值必须适用于为此电子邮件地址指定的地址类型。
