...
- [夏时制帮助和支持中心](http://support.microsoft.com/gp/cp_dst)
- [如何夏时制解决使用 Exchange 日历更新工具](http://support.microsoft.com/kb/941018)
- [如何解决在使用 Microsoft Office outlook 的时区数据更新工具所在的时区更改](http://support.microsoft.com/kb/931667)
