...
- [查找邮件下载历史记录 POP3 帐户](locating-the-message-download-history-for-a-pop3-account.md)： 本主题介绍如何邮件客户端访问[PidTagAttachDataBinary](http://msdn.microsoft.com/library/3b0a8b28-863e-4b96-a4c0-fdb8f40555b9%28Office.15%29.aspx)属性获取 UIDL 历史记录的客户端的 POP3 帐户的收件箱中的邮件。 
