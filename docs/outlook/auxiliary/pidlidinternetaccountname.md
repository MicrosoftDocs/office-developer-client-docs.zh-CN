...
|长 ID （盖）：  <br/> |0x00008580  <br/> |
|数据类型：  <br/> |PT_UNICODE  <br/> |
|区域：  <br/> |常规消息  <br/> |
   
## <a name="remarks"></a>说明

此属性应包含从发送邮件的帐户的帐户管理 API 属性[PROP_ACCT_NAME](prop_acct_name.md)返回的值相同。 
  
消息存储提供程序公开此命名的属性和[PidLidInternetAccountStamp](pidlidinternetaccountstamp.md) ，以便执行以下操作： 
