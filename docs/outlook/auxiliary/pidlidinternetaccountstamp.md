...
|长 ID (盖子):  <br/> |0x00008581  <br/> |
|数据类型：  <br/> |PT_UNICODE  <br/> |
|区域：  <br/> |常规邮件  <br/> |
   
## <a name="remarks"></a>注解

此属性应包含的值与传递邮件的帐户的帐户管理 API 属性[PROP_ACCT_STAMP](prop_acct_stamp.md)返回的值相同。 
  
邮件存储提供程序公开此命名属性和[PidLidInternetAccountName](pidlidinternetaccountname.md) , 以便执行以下操作: 
...
|类型盖子:  <br/> |dispidInetAcctStamp  <br/> |
