...
|[GetMapiSession](iolkaccounthelper-getmapisession.md) <br/> |打开 MAPI 会话，并维护对帐户经理的会话的引用。  <br/> |
|[HandsOffSession](iolkaccounthelper-handsoffsession.md) <br/> |释放由 [IOlkAccountHelper：：GetMapiSession](iolkaccounthelper-getmapisession.md)返回的 MAPI 会话对象。  <br/> |
