...
|[GetProp](iolkaccount-getprop.md) <br/> |获取指定的帐户属性的值。 请参阅下表中的属性表。  <br/> |
|[SetProp](iolkaccount-setprop.md) <br/> |设置指定的帐户属性的值。 请参阅下表中的属性表。  <br/> |
| *占位符成员*  <br/> | *不支持或记录。*  <br/> |
| *占位符成员*  <br/> | *不支持或记录。*  <br/> |
| *占位符成员*  <br/> | *不支持或记录。*  <br/> |
|[FreeMemory](iolkaccount-freememory.md) <br/> |释放由**IOlkAccount**接口分配的内存。  <br/> |
| *占位符成员*  <br/> | *不支持或记录。*  <br/> |
|[SaveChanges](iolkaccount-savechanges.md) <br/> |通过写入注册表存储提交对 account 对象所做的更改。  <br/> |
...
|[PROP_ACCT_ID](prop_acct_id.md) <br/> |返回 outlook 2000 和早期版本的 outlook 中的帐户标识符。  <br/> |
|[PROP_ACCT_IS_EXCH](prop_acct_is_exch.md) <br/> |如果帐户是 Microsoft Exchange 帐户, 则为 True。  <br/> |
|[PROP_ACCT_MINI_UID](prop_acct_mini_uid.md) <br/> |从 outlook 2002 起, 返回 outlook 版本中的帐户标识符。  <br/> |
