...
|**[HRESULT]**|**说明**|
|:-----|:-----|
|S_OK  <br/> |如果 **IOlkAccountHelper** 的实现创建自己的 MAPI 会话，该会话在 **IOlkAccountHelper：：GetMapiSession** 中返回，则必须在此处释放会话并返回 S_OK。  <br/> |
|E_NOTIMPL  <br/> |如果 **IOlkAccountHelper** 的实现未创建自己的 MAPI 会话，则只能返回E_NOTIMPL。 在这种情况下，这是唯一受支持的返回值。  <br/> |
