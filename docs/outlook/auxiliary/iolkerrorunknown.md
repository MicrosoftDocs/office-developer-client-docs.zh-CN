...
此接口提供有关[IOlkAccountManager、IOlkAccountNotify](iolkaccountmanager.md)和[IOlkAccount](iolkaccount.md)中的错误的额外信息。 [](iolkaccountnotify.md) 这也是 **IOlkAccountManager、IOlkAccountNotify** 和 **IOlkAccount** 的基本接口。  
