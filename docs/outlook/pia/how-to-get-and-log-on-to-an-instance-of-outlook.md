...
本主题介绍了如何获取表示本地计算机上正在运行的 Microsoft Outlook 有效实例的 [Application](https://msdn.microsoft.com/library/bb646615\(v=office.15\)) 对象，或新建 Outlook 示例，然后登录默认配置文件并返回相应 Outlook 实例。
