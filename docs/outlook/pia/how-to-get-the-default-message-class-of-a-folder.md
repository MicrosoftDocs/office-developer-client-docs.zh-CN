...
在下面的代码示例中，GetDefaultMessageClass 过程使用 **PropertyAccessor** 确定文件夹的默认表单。 如果找不到文件夹属性 **PR \_ DEF POST \_ \_ MSGCLASS**  [ (PidTagDefaultPostMessageClass) ，Outlook](https://msdn.microsoft.com/library/cc815305\(v=office.15\))引发错误，**则尝试...catch** 块返回 **Folder 的 DefaultMessageClass** **属性**。
