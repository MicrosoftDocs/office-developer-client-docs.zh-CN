...
---
# <a name="filter-recurring-appointments-and-search-for-a-string-in-the-subject"></a><span data-ttu-id="ef4ec-102">筛选定期约会并在主题中搜索某个字符串</span><span class="sxs-lookup"><span data-stu-id="ef4ec-102">Filter recurring appointments and search for a string in the subject</span></span>

<span data-ttu-id="ef4ec-103">该示例筛选“日历”文件夹中某一日期范围内的定期约会，然后以两种方式在主题中搜索字符串“office”。</span><span class="sxs-lookup"><span data-stu-id="ef4ec-103">This example filters recurring appointments that fall within a date range in a Calendar folder, and then searches in two ways for the string "office" in the subject.</span></span>

## <a name="example"></a><span data-ttu-id="ef4ec-104">示例</span><span class="sxs-lookup"><span data-stu-id="ef4ec-104">Example</span></span>

<span data-ttu-id="ef4ec-105">此代码示例使用 [Items](https://msdn.microsoft.com/library/bb645287\(v=office.15\)) 集合（而不是 [Table](https://msdn.microsoft.com/library/bb652856\(v=office.15\)) 对象）筛选定期约会，因为 **Table** 对象仅返回主要系列约会，不包括文件夹中的定期项。</span><span class="sxs-lookup"><span data-stu-id="ef4ec-105">To filter recurring appointments, this code sample uses the [Items](https://msdn.microsoft.com/library/bb645287\(v=office.15\)) collection instead of the [Table](https://msdn.microsoft.com/library/bb652856\(v=office.15\)) object, because the **Table** object returns only the master series appointments and does not include recurring items in the folder.</span></span> <span data-ttu-id="ef4ec-106">为了在调用 [Find(String)](https://msdn.microsoft.com/library/bb646289\(v=office.15\)) 或 [Restrict(String)](https://msdn.microsoft.com/library/bb612531\(v=office.15\)) 方法时添加定期约会，此代码示例设置 **Items** 集合的 [IncludeRecurrences](https://msdn.microsoft.com/library/bb646522\(v=office.15\)) 属性，然后按 [Start](https://msdn.microsoft.com/library/bb647263\(v=office.15\)) 属性对文件夹中的约会进行排序。</span><span class="sxs-lookup"><span data-stu-id="ef4ec-106">To include recurring appointments when calling the [Find(String)](https://msdn.microsoft.com/library/bb646289\(v=office.15\)) or [Restrict(String)](https://msdn.microsoft.com/library/bb612531\(v=office.15\)) method, the code sample sets the [IncludeRecurrences](https://msdn.microsoft.com/library/bb646522\(v=office.15\)) property of the **Items** collection, and then sorts appointments in the folder by their [Start](https://msdn.microsoft.com/library/bb647263\(v=office.15\)) property.</span></span> <span data-ttu-id="ef4ec-107">然后，它使用 Jet 查询，指定定期约会的开始日期和结束日期。</span><span class="sxs-lookup"><span data-stu-id="ef4ec-107">It then uses a Jet query to specify start and end dates for the recurrences.</span></span>

<span data-ttu-id="ef4ec-108">获取指定日期范围内定期约会项的 **Items** 集合后，此代码示例使用 DAV 搜索和定位 (DASL) 查询执行其他两种搜索。</span><span class="sxs-lookup"><span data-stu-id="ef4ec-108">After obtaining an **Items** collection of recurring appointment items that fall within the specified range of dates, the code sample carries out two more searches using DAV Searching and Locating (DASL) queries.</span></span> <span data-ttu-id="ef4ec-109">第一种搜索使用 **Items.Find**、[FindNext](https://msdn.microsoft.com/library/bb623799\(v=office.15\)) 和 **like** 关键字，搜索主题中有“office”子字符串的项。</span><span class="sxs-lookup"><span data-stu-id="ef4ec-109">The first search uses **Items.Find**, [FindNext](https://msdn.microsoft.com/library/bb623799\(v=office.15\)), and the **like** keyword to search for items that have "office" as a substring in the subject.</span></span> <span data-ttu-id="ef4ec-110">第二种搜索使用 **Items.Restrict** 方法和 **ci\_startswith** 关键字，搜索主题以“office”开头的项。</span><span class="sxs-lookup"><span data-stu-id="ef4ec-110">The second search uses the **Items.Restrict** method and the **ci\_startswith** keyword to search for items that have subjects beginning with "office."</span></span>

<span data-ttu-id="ef4ec-111">如果使用 Visual Studio 测试此代码示例，必须先添加对 Microsoft Outlook 15.0 对象库组件的引用，并在导入 **Microsoft.Office.Interop.Outlook** 命名空间时指定 Outlook 变量。</span><span class="sxs-lookup"><span data-stu-id="ef4ec-111">If you use Visual Studio to test this code example, you must first add a reference to the Microsoft Outlook 15.0 Object Library component and specify the Outlook variable when you import the **Microsoft.Office.Interop.Outlook** namespace.</span></span> <span data-ttu-id="ef4ec-112">不得将 **Imports** 或 **using** 语句直接添加到此代码示例中的函数前面，这两个语句必须后跟公共类声明。</span><span class="sxs-lookup"><span data-stu-id="ef4ec-112">The **Imports** or **using** statement must not occur directly before the functions in the code example but must be added before the public Class declaration.</span></span> <span data-ttu-id="ef4ec-113">下面几段代码行展示了如何在 Visual Basic 和 C\# 中执行导入和分配操作。</span><span class="sxs-lookup"><span data-stu-id="ef4ec-113">The following lines of code show how to do the import and assignment in Visual Basic and C\#.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="ef4ec-114">另请参阅</span><span class="sxs-lookup"><span data-stu-id="ef4ec-114">See also</span></span>

- [<span data-ttu-id="ef4ec-115">搜索和筛选</span><span class="sxs-lookup"><span data-stu-id="ef4ec-115">Search and filter</span></span>](search-and-filter.md)
