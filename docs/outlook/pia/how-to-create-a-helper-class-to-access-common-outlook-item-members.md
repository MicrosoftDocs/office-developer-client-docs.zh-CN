...
---
# <a name="create-a-helper-class-to-access-common-outlook-item-members"></a><span data-ttu-id="4161c-102">创建用于访问常见 Outlook 项成员的帮助程序类</span><span class="sxs-lookup"><span data-stu-id="4161c-102">Create a Helper class to access common Outlook item members</span></span>

<span data-ttu-id="4161c-103">此示例展示如何实现用于访问 Outlook 项对象的通用属性和方法的 OutlookItem 帮助程序类，从而在访问这些常见项成员之前节省特定项对象的测试和转换开销。</span><span class="sxs-lookup"><span data-stu-id="4161c-103">This example shows how to implement an OutlookItem helper class that accesses common properties and methods of Outlook item objects, saving the overhead of testing for and casting to a specific item object before accessing these common item members.</span></span>

## <a name="example"></a><span data-ttu-id="4161c-104">示例</span><span class="sxs-lookup"><span data-stu-id="4161c-104">Example</span></span>

> [!NOTE] 
> <span data-ttu-id="4161c-105">下面的代码示例摘录自 [Microsoft Office Outlook 2007 应用程序编程](https://www.amazon.com/gp/product/0735622493?ie=UTF8&tag=msmsdn-20&linkCode=as2&camp=1789&creative=9325&creativeASIN=0735622493)。</span><span class="sxs-lookup"><span data-stu-id="4161c-105">The following code example is an excerpt from [Programming Applications for Microsoft Office Outlook 2007](https://www.amazon.com/gp/product/0735622493?ie=UTF8&tag=msmsdn-20&linkCode=as2&camp=1789&creative=9325&creativeASIN=0735622493).</span></span>


<span data-ttu-id="4161c-106">许多 Outlook 项都具有类似的属性和方法。</span><span class="sxs-lookup"><span data-stu-id="4161c-106">Many Outlook items have similar properties and methods.</span></span> <span data-ttu-id="4161c-107">例如，**Application**、**Attachments**、**Body**、**Categories** 和 **Class** 属性以及 **Close**、**Copy** 和 **Display** 方法是所有 Outlook 项对象通用的。</span><span class="sxs-lookup"><span data-stu-id="4161c-107">For example, the **Application**, **Attachments**, **Body**, **Categories**, and **Class** properties, and **Close**, **Copy**, and **Display** methods are common to all Outlook item objects.</span></span> <span data-ttu-id="4161c-108">基于 COM 的 Outlook 对象模型会返回通用 Visual Basic **对象**，而不是许多成员的确切项目类型。</span><span class="sxs-lookup"><span data-stu-id="4161c-108">The COM-based Outlook object model returns the generic Visual Basic **Object** instead of the exact item type for many members.</span></span> 

<span data-ttu-id="4161c-109">例如，[CurrentItem](https://msdn.microsoft.com/library/bb611743\(v=office.15\)) 属性会返回一个通用**对象**。</span><span class="sxs-lookup"><span data-stu-id="4161c-109">For example, the [CurrentItem](https://msdn.microsoft.com/library/bb611743\(v=office.15\)) property returns a generic **Object**.</span></span> <span data-ttu-id="4161c-110">另一方面，强类型托管代码环境需要将代表 Outlook 项的**对象**转换至确切 Outlook 类型，例如 **MailItem**。</span><span class="sxs-lookup"><span data-stu-id="4161c-110">On the other hand, the strongly typed managed code environment requires you to cast the **Object** representing an Outlook item to the exact Outlook type such as **MailItem**.</span></span> 

<span data-ttu-id="4161c-111">OutlookItem 帮助程序类使用反射来显示所有项的通用属性和方法。</span><span class="sxs-lookup"><span data-stu-id="4161c-111">The OutlookItem helper class uses reflection to expose properties and methods that are common to all items.</span></span> <span data-ttu-id="4161c-112">这种类可帮助你将对象转换至确切类型，而且方便直接在 **OutlookItem** 对象上使用通用项属性或方法。</span><span class="sxs-lookup"><span data-stu-id="4161c-112">The class helps you cast the object to the exact type and provides the convenience of directly using common item properties or methods on the **OutlookItem** object.</span></span> <span data-ttu-id="4161c-113">这是一种非常有用的技术，而且**另请参阅**部分列出的几个其他有关操作方法的主题均利用了此帮助程序类。</span><span class="sxs-lookup"><span data-stu-id="4161c-113">This is a very useful technique, and several other how-to topics listed in the **See also** section take advantage of this helper class.</span></span>

<span data-ttu-id="4161c-114">如果使用 Visual Studio 测试此代码示例，必须先添加对 Microsoft Outlook 15.0 对象库组件的引用，并在导入 **Microsoft.Office.Interop.Outlook** 命名空间时指定 Outlook 变量。</span><span class="sxs-lookup"><span data-stu-id="4161c-114">If you use Visual Studio to test this code example, you must first add a reference to the Microsoft Outlook 15.0 Object Library component and specify the Outlook variable when you import the **Microsoft.Office.Interop.Outlook** namespace.</span></span> <span data-ttu-id="4161c-115">不得将 **Imports** 或 **using** 语句直接添加到此代码示例中的函数前面，而且这两个语句必须后跟公共类声明。</span><span class="sxs-lookup"><span data-stu-id="4161c-115">The **Imports** or **using** statement must not occur directly before the functions in the code example but must be added before the public Class declaration.</span></span> <span data-ttu-id="4161c-116">下面几行代码展示了如何在 Visual Basic 和 C\# 中执行导入和分配操作。</span><span class="sxs-lookup"><span data-stu-id="4161c-116">The following lines of code show how to do the import and assignment in Visual Basic and C\#.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="4161c-117">另请参阅</span><span class="sxs-lookup"><span data-stu-id="4161c-117">See also</span></span>

- [<span data-ttu-id="4161c-118">显示活跃资源管理器中的选定项</span><span class="sxs-lookup"><span data-stu-id="4161c-118">Display selected items in the active Explorer</span></span>](how-to-display-selected-items-in-the-active-explorer.md)
- [<span data-ttu-id="4161c-119">打开并显示 iCalendar 文件内容</span><span class="sxs-lookup"><span data-stu-id="4161c-119">Open and display the contents of an iCalendar file</span></span>](how-to-open-and-display-the-contents-of-an-icalendar-file.md)
- [<span data-ttu-id="4161c-120">将类别分配给项目</span><span class="sxs-lookup"><span data-stu-id="4161c-120">Assign categories to an item</span></span>](how-to-assign-categories-to-an-item.md)
- [<span data-ttu-id="4161c-121">为检查器实现包装并在每个检查器中跟踪项目级事件</span><span class="sxs-lookup"><span data-stu-id="4161c-121">Implement a wrapper for inspectors and track item-level events in each inspector</span></span>](how-to-implement-a-wrapper-for-inspectors-and-track-item-level-events-in-each-inspector.md)
- [<span data-ttu-id="4161c-122">常规 Outlook 项</span><span class="sxs-lookup"><span data-stu-id="4161c-122">General Outlook items</span></span>](general-outlook-items.md)
