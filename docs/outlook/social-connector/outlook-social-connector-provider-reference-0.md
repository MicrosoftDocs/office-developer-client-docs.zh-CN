...
description: 本节包含适用于 Outlook Social Connector (.osc) 提供程序可扩展性的参考主题。
...
本节包含适用于 Outlook Social Connector (.osc) 提供程序可扩展性的参考主题。
  
## <a name="in-this-section"></a>本节内容

- [接口](outlook-social-connector-provider-interfaces.md)
  
- [XML 架构](outlook-social-connector-provider-xml-schema.md)
  
- [错误代码](outlook-social-connector-provider-error-codes.md)
