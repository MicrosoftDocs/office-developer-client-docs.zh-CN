...
ms.locfileid: "25395922"
---
# <a name="osc-sample-templates"></a>OSC 示例模板

随附 Outlook Social Connector 2013 提供程序参考是 c + + C# 和 Visual Basic 中的多个提供程序模板。 您可以下载模板： [Outlook Social Connector 2013： 提供程序模板](https://code.msdn.microsoft.com/Outlook-Social-Connector-73fd8d2c)。
