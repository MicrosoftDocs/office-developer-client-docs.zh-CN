...
下图显示了"完整页面"视图、"停靠到桌面"视图和快速备注在桌面上的外观。
  
**OneNote 视图**

![OneNote窗口视图OneNote](media/ON15Con_views.jpg "窗口视图")
  
## <a name="interfaces"></a>接口

本节列出的接口和成员的可用于以编程方式修改 OneNote 窗口。
  
### <a name="windows-interface"></a>Windows接口
...
### <a name="window-interface"></a>窗口接口
...
|**Application** <br/> |**应用程序** <br/> |获取与窗口关联的 OneNote **Application** 对象。  <br/> |
...
|||
|:-----|:-----|
|**描述** <br/> |如果传递的 OneNote 链接 （onenote: / /)，在 OneNote 中打开 OneNote 窗口到相应位置。 但是，如果链接是外部链接（如 https:// 或 file://，将显示一个安全对话框。 时开除，OneNote 尝试打开链接，并返回 HResult.hrObjectDoesNotExist 错误。  <br/> |
