...
- 开发包含代码的[InfoPath](https://msdn.microsoft.com/library/b43ada73-349d-498f-a8bb-e8fd5020d207%28Office.15%29.aspx)表单模板 ：介绍如何为 InfoPath 表单模板创建项目，这些表单模板具有以托管代码 (Visual Basic 或C#) [Microsoft.Office 的成员编写的业务逻辑。InfoPath](https://msdn.microsoft.com/library/Microsoft.Office.InfoPath.aspx)命名空间。 
...
- [自动化来自其他应用程序的 InfoPath：](automating-infopath-from-other-applications.md)介绍 InfoPath 主互操作和 XML 互操作程序集，以及如何使用它们的类型和成员通过托管代码从外部应用程序自动执行 InfoPath。
