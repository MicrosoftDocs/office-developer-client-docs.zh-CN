...
查找与开发解决方案和自定义 InfoPath 相关的操作说明内容、技术文章、参考和博客文章。
...
- [表单模板（含代码）开发人员参考](form-templates/infopath-developer-reference-for-form-templates.md)
  
- [外部自动化开发人员参考](external-automation/infopath-developer-reference-for-external-automation.md)
