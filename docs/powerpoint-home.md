...
- [PowerPoint VBA 参考](https://docs.microsoft.com/office/vba/api/overview/powerpoint)
...
- [PowerPoint 加载项入门](https://docs.microsoft.com/office/dev/add-ins/quickstarts/powerpoint-quickstart?tabs=visual-studio)
  
- [平台概述](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>代码示例
  
- [Office 开发中心内的 PowerPoint 代码示例](https://developer.microsoft.com/office/gallery/?filterBy=Samples,PowerPoint)
