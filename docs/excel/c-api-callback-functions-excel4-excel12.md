...
- 可变长度参数列表表单 (**Excel4/Excel12**)
    
- 参数数组形式 (**Excel4v/Excel12v**)
    
除了将参数传递给这些回调的方式外, 这两个窗体在功能上是等效的。 [Excel4/Excel12](excel4-excel12.md)中完全介绍了这两种形式的基本概念。 [Excel4v/Excel12v](excel4v-excel12v.md)涵盖有关此窗体的其他问题。 
