...
---
# <a name="develop-solutions-and-customize-excel"></a>开发解决方案和自定义 Excel

查找开发解决方案和自定义 Excel 的操作方法内容、示例代码、SDK 和 API 文档、VBA 参考、培训和技术文章。
  
> [!NOTE]
> 有兴趣开发跨[多个平台](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-in-availability)扩展 Office 体验的解决方案吗？ 查看新的 [Excel 加载项模型](https://docs.microsoft.com/office/dev/add-ins/excel/excel-add-ins-overview)。 
  
### <a name="viewed-most"></a>浏览次数最多
  
- [Excel VBA 参考](https://docs.microsoft.com/office/vba/api/overview/excel)
...
- [Excel 加载项入门](https://docs.microsoft.com/office/dev/add-ins/excel/excel-add-ins-get-started-overview)
  
- [平台概述](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-ins)

- [JavaScript 自定义函数](https://docs.microsoft.com/office/dev/add-ins/excel/custom-functions-overview)
...
- [优化性能障碍的提示](https://docs.microsoft.com/office/vba/excel/concepts/excel-performance/excel-tips-for-optimizing-performance-obstructions)
