...
- [使用 Excel 中的 C API 进行编程](programming-with-the-c-api-in-excel.md)： 介绍 C API 并讨论如何在 Excel 2013 中的其他编程选项比较。
    
- [What's New in Excel 的 C API](what-s-new-in-the-c-api-for-excel.md)： 介绍与 Excel 2013 的 C API 更新。
