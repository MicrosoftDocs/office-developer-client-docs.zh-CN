...
<span data-ttu-id="63e89-109">以下主题介绍如何管理内存和 xll （英文） 中的线程数：</span><span class="sxs-lookup"><span data-stu-id="63e89-109">The following topics describe how to manage memory and threads in XLLs:</span></span>
