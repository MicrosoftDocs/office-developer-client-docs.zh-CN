...
---
# <a name="raiseerror-macro-action-access-custom-web-app"></a>RaiseError 宏操作 (Access 自定义 web 应用程序)

**RaiseError**操作将显示一个弹出窗口, 其中包含指定的错误消息。 
...
调用**RaiseError**操作时, 当前事务中的所有操作都会回滚。 
