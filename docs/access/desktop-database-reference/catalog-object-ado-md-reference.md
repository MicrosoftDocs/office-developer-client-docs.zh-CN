...
---
# <a name="catalog-object-ado-md-reference"></a>Catalog 对象 （ADO MD 参考 （英文）

**适用于**： Access 2013、 Office 2013

- [Catalog 对象 (ADO MD)](catalog-object-ado-md.md)
- [目录属性、 方法和事件 (ADO MD)](catalog-properties-methods-and-events-ado-md.md)
