...
ms.locfileid: "32284523"
---
# <a name="recordset-object-ado-reference"></a>Recordset 对象 (ADO) 引用

**适用于**：Access 2013、Office 2013

- [Recordset 对象 (ADO)](recordset-object-ado.md)
- [Recordset 的属性、方法和事件 (ADO)](recordset-properties-methods-and-events-ado.md)
