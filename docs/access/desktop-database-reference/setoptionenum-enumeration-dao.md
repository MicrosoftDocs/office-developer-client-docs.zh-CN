...
---
# <a name="setoptionenum-enumeration-dao"></a>SetOptionEnum 枚举 (DAO)


**适用于**：Access 2013、Office 2013

与 **SetOption** 方法一起用来指定 Windows 注册表中要重写的 Microsoft Access 数据库引擎项。
...
<td><p>82</p></td>
<td><p>加密密钥长度。必须是从 40 开始的 8 的倍数。</p></td>
</tr>
<tr class="odd">
