...
ms.locfileid: "25466430"
---
# <a name="openschema-method-example-vc"></a><span data-ttu-id="45782-102">OpenSchema 方法示例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="45782-102">OpenSchema Method Example (VC++)</span></span>


<span data-ttu-id="45782-103">**适用于**： Access 2013 |Office 2013</span><span class="sxs-lookup"><span data-stu-id="45782-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="45782-104">本示例使用 [OpenSchema](openschema-method-ado.md) 方法来显示 ***Pubs*** 数据库中每个表的名称和类型。</span><span class="sxs-lookup"><span data-stu-id="45782-104">This example uses the [OpenSchema](openschema-method-ado.md) method to display the name and type of each table in the ***Pubs*** database.</span></span>
