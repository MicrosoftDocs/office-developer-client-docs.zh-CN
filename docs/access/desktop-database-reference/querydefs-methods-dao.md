...
ms.locfileid: "32303225"
---
# <a name="querydefs-methods-dao"></a>QueryDefs 方法 (DAO)

**适用于**：Access 2013、Office 2013

- [QueryDefs 方法 (DAO)](querydefs-append-method-dao.md)
- [QueryDefs 方法 (DAO)](querydefs-delete-method-dao.md)
- [QueryDefs 方法 (DAO)](querydefs-refresh-method-dao.md)
