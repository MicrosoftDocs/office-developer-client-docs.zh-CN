...
如果此 **Record** 是从 [Recordset](recordset-object-ado.md) 获取的，则该操作的结果将不会立即反映到 **Recordset** 中。 刷新**recordset** , 方法是关闭并重新打开它, 或者通过执行**recordset** [Requery 查询](requery-method-ado.md)或[更新](update-method-ado.md)和重新[同步](resync-method-ado.md)方法来刷新。
