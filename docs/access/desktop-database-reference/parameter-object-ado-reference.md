...
---
# <a name="parameter-object-ado-reference"></a>Parameter 对象 (ADO) 引用

**适用于**：Access 2013、Office 2013

- [Parameter 对象 (ADO)](parameter-object-ado.md)
- [参数属性、方法和事件 (ADO)](parameter-properties-methods-and-events-ado.md)
