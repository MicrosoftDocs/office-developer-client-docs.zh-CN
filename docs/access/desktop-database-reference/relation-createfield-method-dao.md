...
---
# <a name="relationcreatefield-method-dao"></a>CreateField 方法 (DAO)
...
<td><p>一个 String 类型的值，用于对新的 <strong>Field</strong> 对象进行唯一命名。 有关有效<strong>字段</strong>名称的详细信息, 请参阅<strong><a href="connection-name-property-dao.md">Name</a></strong>属性。</p></td>
</tr>
<tr class="even">
...
type 和 size 参数仅适用于**TableDef**对象中的**Field**对象。 如果 **Field** 对象与 **Index** 或 **Relation** 对象关联，则会忽略这些参数。
