...
ms.locfileid: "32281858"
---
# <a name="addnew-method-example-vj"></a><span data-ttu-id="c6cc0-102">AddNew 方法示例 (VJ++)</span><span class="sxs-lookup"><span data-stu-id="c6cc0-102">AddNew method example (VJ++)</span></span>


<span data-ttu-id="c6cc0-103">**适用于**：Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="c6cc0-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="c6cc0-104">以下示例使用 [AddNew](addnew-method-ado.md) 方法创建一个具指定名称的新记录。</span><span class="sxs-lookup"><span data-stu-id="c6cc0-104">This example uses the [AddNew](addnew-method-ado.md) method to create a new record with the specified name.</span></span>
