...
---
# <a name="fieldforeignname-property-dao"></a>ForeignName 属性 (DAO)
...
**Field**对象的**[Name](connection-name-property-dao.md)** 和**ForeignName**属性设置指定关系的主表和外表中相应字段的名称。 **Relation**对象的**[Table](relation-table-property-dao.md)** 和**[ForeignTable](relation-foreigntable-property-dao.md)** 属性设置决定了关系的主表和外表。
