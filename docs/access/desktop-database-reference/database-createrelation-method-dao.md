...
---
# <a name="databasecreaterelation-method-dao"></a>CreateRelation 方法 (DAO)

**适用于**：Access 2013、Office 2013

创建新的**[Relation](relation-object-dao.md)** 对象 (仅适用于 Microsoft Access 工作区)。 .

## <a name="syntax"></a>语法

*表达式*。CreateRelation (***Name***、 ***Table***、 ***ForeignTable***、 ***Attributes***)
...
<td><p>一个 <strong>Variant</strong>（<strong>String</strong> 子类型），用于对新的 <strong>Relation</strong> 对象进行唯一命名。 有关有效<strong>关系</strong>名称的详细信息, 请参阅<strong><a href="connection-name-property-dao.md">Name</a></strong>属性。</p></td>
</tr>
<tr class="even">
...
在对**Relation**对象使用**[Append](fields-append-method-dao.md)** 方法之前, 必须追加相应的**[Field](field-object-dao.md)** 对象以定义主键和外键关系表。

如果 name 引用了已经是集合成员的对象, 或者如果在从属**Fields**集合中提供的**Field**对象名称无效, 则在使用**Append**方法时将发生运行时错误。
