...
---
# <a name="microsoft-data-access-objects-reference"></a>Microsoft 数据访问对象引用
...
- [文档](documents-object-reference-dao.md)
...
- [索引](index-object-reference-dao.md)
- [Indexes](indexes-object-reference-dao.md)
- [Parameter](parameter-object-reference-dao.md)
- [参数](parameters-object-reference-dao.md)
- [属性](properties-object-reference-dao.md)
- [属性](property-object-reference-dao.md)
...
- [枚举 （DAO 参考 （英文）](enumerations-dao-reference.md)
