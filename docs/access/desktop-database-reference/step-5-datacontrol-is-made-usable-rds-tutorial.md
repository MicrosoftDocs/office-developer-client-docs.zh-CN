...
---
# <a name="step-5-datacontrol-is-made-usable-rds-tutorial"></a>步骤 5：DataControl 可用（RDS 教程）
...
例如，如果显示网页的 Microsoft Internet Explorer 中，您可能想要在可视控件中显示的**Recordset**对象数据。 网页上的可视控件不能直接访问**Recordset**对象。 但是，它们可以通过 **RDS.DataControl** 访问 [Recordset](datacontrol-object-rds.md) 对象。 当 **RDS.DataControl** 的 [SourceRecordset](recordset-sourcerecordset-properties-rds.md) 属性设置为 **Recordset** 对象时，RDS.DataControl 便可被可视控件使用。
