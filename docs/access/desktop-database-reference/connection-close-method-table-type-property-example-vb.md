...
---
# <a name="connection-close-method-table-type-property-example-vb"></a><span data-ttu-id="ffaa2-102">Connection 的 Close 方法、Table 的 Type 属性示例 (VB)</span><span class="sxs-lookup"><span data-stu-id="ffaa2-102">Connection Close Method, Table Type Property Example (VB)</span></span>
...
<span data-ttu-id="ffaa2-108">关闭用于"打开"目录的 [Connection](connection-object-ado.md) 对象应与将 **ActiveConnection** 属性设置为 **Nothing** 效果相同。</span><span class="sxs-lookup"><span data-stu-id="ffaa2-108">Closing a [Connection](connection-object-ado.md) object that was used to "open" the catalog should have the same effect as setting the **ActiveConnection** property to **Nothing**.</span></span>
