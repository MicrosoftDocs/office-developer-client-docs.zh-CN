...
此外，此对象包含用于创建您可以编程方式填充的空**Recordset**对象的方法 ([CreateRecordset](createrecordset-method-rds.md))，和用于将**Recordset**对象转换为文本字符串来构建网页 ([的另一种方法ConvertToString](converttostring-method-rds.md))。
