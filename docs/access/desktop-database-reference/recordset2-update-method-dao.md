...
---
# <a name="recordset2update-method-dao"></a>Recordset2 方法 (DAO)

**适用于**：Access 2013、Office 2013

## <a name="syntax"></a>语法

*表达式*。Update (***UpdateType***, ***Force***)
...
<td><p>一个指示更新类型的<strong><a href="updatetypeenum-enumeration-dao.md">UpdateTypeEnum</a></strong>常量, 如 Settings (仅 ODBCDirect workspace) 中所指定。</p></td>
</tr>
<tr class="even">
<td><p><em>Force</em></p></td>
<td><p>可选</p></td>
<td><p><strong>Boolean</strong></p></td>
<td><p>一个<strong>布尔</strong>值, 指示是否强制对数据库进行更改, 而不管是否由于<strong><a href="recordset-addnew-method-dao.md">AddNew</a></strong>、 <strong><a href="fields-delete-method-dao.md">Delete</a></strong>或<strong><a href="recordset2-edit-method-dao.md">Edit</a></strong>调用而使其他用户更改了基础数据。 如果为 <strong>True</strong>，则会强制更改，并且只是覆盖由其他用户所做的更改。 如果为 <strong>False</strong>（默认值），在更新处于待定状态时由其他用户所做的更改将导致更改对冲突的更改失败。 不会发生错误, 但<strong><a href="recordset-batchcollisioncount-property-dao.md">BatchCollisionCount</a></strong>和<strong>BatchCollisions</strong>属性将分别指示冲突的数量和受冲突影响的行 (仅限 ODBCDirect 工作区)。</p></td>
</tr>
</tbody>
</table>
