...
---
# <a name="recordsetfindprevious-method-dao"></a>FindPrevious 方法 (DAO)
...
> [!NOTE]
> - 为了获得最佳性能,*条件*应为 "*字段* = *值*" 窗体中的*字段*是基础基表中的索引字段, 或者是 "*字段*类似于*前缀*", 其中*字段*是基础基表中的索引字段和*前缀*是前缀搜索字符串 (例如, "ART *")。
