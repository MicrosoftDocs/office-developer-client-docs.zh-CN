...
ms.locfileid: "25862519"
---
# <a name="ado-code-examples-in-microsoft-visual-j-access"></a>ADO 代码示例在 Microsoft Visual J + + (Access)
...
>>>>>>> 母版
  ...
  - [Append 和 CreateParameter 方法示例 (VJ++)](append-and-createparameter-methods-example-vj.md)
...
>>>>>>> 母版
  ...
  - [Clone 方法示例 (VJ++)](clone-method-example-vj.md)
...
<<<<<<< 头
  ...
  - [Description、HelpContext、HelpFile、NativeError、Number、Source 和 SQLState 属性示例 (VJ++)](description-helpcontext-helpfile-nativeerror-number-source-and-sqlstate-properties-example-vj.md)
...
>>>>>>> 母版
  ...
  - [GetRows 方法示例 (VJ++)](getrows-method-example-vj.md)
...
>>>>>>> 母版
  ...
  - [MoveFirst、MoveLast、MoveNext 和 MovePrevious 方法示例 (VJ++)](movefirst-movelast-movenext-and-moveprevious-methods-example-vj.md)
...
>>>>>>> 母版
  ...
  - [Resync 方法示例 (VJ++)](resync-method-example-vj.md)
...
>>>>>>> 母版
  ...
  - [Update 和 CancelUpdate 方法示例 (VJ++)](update-and-cancelupdate-methods-example-vj.md)
