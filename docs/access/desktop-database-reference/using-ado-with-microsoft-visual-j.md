...
ms.locfileid: "25468820"
---
# <a name="using-ado-with-microsoft-visual-j"></a>在 Microsoft Visual J++ 中使用 ADO
...
有关在 Visual J++ 中使用 ADO 的详细信息，请参阅以下主题：
  ...
  - [ADO/WFC 语法索引](https://msdn.microsoft.com/library/jj250066\(v=office.15\))
