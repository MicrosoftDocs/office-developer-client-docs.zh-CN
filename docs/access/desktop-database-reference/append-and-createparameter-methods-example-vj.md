---
title: Append 和 CreateParameter 方法示例 (VJ++)
...
ms.locfileid: "32297114"
---
# <a name="append-and-createparameter-methods-example-vj"></a><span data-ttu-id="83c93-102">Append 和 CreateParameter 方法示例 (VJ++)</span><span class="sxs-lookup"><span data-stu-id="83c93-102">Append and CreateParameter methods example (VJ++)</span></span>


<span data-ttu-id="83c93-103">**适用于**：Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="83c93-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="83c93-104">以下示例使用 [Append](append-method-ado.md) 和 [CreateParameter](createparameter-method-ado.md) 方法执行带输入参数的存储过程。</span><span class="sxs-lookup"><span data-stu-id="83c93-104">This example uses the [Append](append-method-ado.md) and [CreateParameter](createparameter-method-ado.md) methods to execute a stored procedure with an input parameter.</span></span>
