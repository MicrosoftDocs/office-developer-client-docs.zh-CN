...
<td><p>返回一个值, 该值指示<strong><a href="index-object-dao.md">Index</a></strong>对象是否表示表中的外键 (仅适用于 Microsoft Access 工作区)。 .</p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td><p><strong><a href="index-primary-property-dao.md">主</a></strong></p></td>
...
<tr class="even">
<td><p><strong><a href="index-unique-property-dao.md">独特</a></strong></p></td>
