...
<td><p>创建一个引用原始<strong>Recordset2</strong>对象的重复<strong><a href="recordset-object-dao.md">Recordset</a></strong>对象。</p></td>
</tr>
<tr class="odd">
...
<td><p>返回一个<strong><a href="querydef-object-dao.md">querydef</a></strong>对象, 该对象是用于创建 recordset 占位符表示的<strong><a href="recordset-object-dao.md">recordset</a></strong>对象的<strong>querydef</strong>副本 (仅适用于 Microsoft Access 工作区)。 .</p></td>
</tr>
<tr class="odd">
...
<td><p>设置或返回一个值，该值确定在随后打开的 <strong>Recordset</strong> 对象中包括的记录（仅适用于 Microsoft Access 工作区）。 可读写 <strong>String</strong>。</p></td>
</tr>
<tr class="even">
...
<td><p>通过使用 <strong><a href="recordset2-seek-method-dao.md">Seek</a></strong> 方法或 <strong><a href="recordset2-findfirst-method-dao.md">Find</a></strong> 方法之一，指示是否找到了特定记录（仅适用于 Microsoft Access 工作区）。</p></td>
</tr>
<tr class="even">
...
<td><p>设置或返回一个值, 该值基于<strong>recordset</strong>中记录的百分比指示<strong><a href="recordset-object-dao.md">recordset</a></strong>对象中当前记录的大概位置。</p></td>
</tr>
<tr class="even">
