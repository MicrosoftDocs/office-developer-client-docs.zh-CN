...
ms.locfileid: "25468959"
---
# <a name="status-property-example-field-vb"></a><span data-ttu-id="7755c-102">Status 属性示例 (Field) (VB)</span><span class="sxs-lookup"><span data-stu-id="7755c-102">Status Property Example (Field) (VB)</span></span>


<span data-ttu-id="7755c-103">**适用于**： Access 2013 |Office 2013</span><span class="sxs-lookup"><span data-stu-id="7755c-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="7755c-p101">下面的示例使用 [Internet Publishing Provider](microsoft-ole-db-provider-for-internet-publishing.md) 从可读写的文件夹中打开一个文档。首先将 [Record](status-property-ado-field.md) 的 [Field](field-object-ado.md) 对象的 [Status](record-object-ado.md) 属性设置为 **adFieldPendingInsert** ，然后更新为 **adFieldOk** 。</span><span class="sxs-lookup"><span data-stu-id="7755c-p101">The following example opens a document from a read/write folder using the [Internet Publishing Provider](microsoft-ole-db-provider-for-internet-publishing.md). The [Status](status-property-ado-field.md) property of a [Field](field-object-ado.md) object of the [Record](record-object-ado.md) will first be set to **adFieldPendingInsert**, then be updated to **adFieldOk**.</span></span>
...
<span data-ttu-id="7755c-p102">下面的示例删除从文档打开的 **Record** 中的已知 **Field** 。首先将 **Status** 属性设置为 **adFieldOK** ，然后更新为 **adFieldPendingUnknown** 。</span><span class="sxs-lookup"><span data-stu-id="7755c-p102">The following example deletes a known **Field** from a **Record** opened from a document. The **Status** property will first be set to **adFieldOK**, then **adFieldPendingUnknown**.</span></span>
