...
**Field2** 对象包含与 **[Field](field-object-dao.md)** 对象相同的所有属性和方法，并且 **Field2** 对象还包含几个支持多值字段类型的新增属性和方法。这几个新属性和方法是：

- **[AppendOnly](field2-appendonly-property-dao.md)** 属性

- **[ComplexType](field2-complextype-property-dao.md)** 属性

- **[IsComplex](field2-iscomplex-property-dao.md)** 属性

- **[LoadFromFile](field2-loadfromfile-method-dao.md)** 方法

- **[SaveToFile](field2-savetofile-method-dao.md)** 方法
