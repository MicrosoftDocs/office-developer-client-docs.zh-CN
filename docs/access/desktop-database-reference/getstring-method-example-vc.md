...
ms.locfileid: "25860516"
---
# <a name="getstring-method-example-vc"></a><span data-ttu-id="9270e-102">GetString 方法示例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="9270e-102">GetString method example (VC++)</span></span>


<span data-ttu-id="9270e-103">**适用于**： Access 2013 |Office 2013</span><span class="sxs-lookup"><span data-stu-id="9270e-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="9270e-104">本示例演示 [GetString](getstring-method-ado.md) 方法。</span><span class="sxs-lookup"><span data-stu-id="9270e-104">This example demonstrates the [GetString](getstring-method-ado.md) method.</span></span>

<span data-ttu-id="9270e-105">假设您正在调试某个数据访问问题，并且需要一种快速、简便的方法来显示较小 [Recordset](recordset-object-ado.md) 的当前内容。</span><span class="sxs-lookup"><span data-stu-id="9270e-105">Assume you are debugging a data access problem and want a quick, simple way of printing the current contents of a small [Recordset](recordset-object-ado.md).</span></span>
