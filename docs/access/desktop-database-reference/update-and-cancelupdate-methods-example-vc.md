...
ms.locfileid: "25863813"
---
# <a name="update-and-cancelupdate-methods-example-vc"></a><span data-ttu-id="dc7bf-102">Update 和 CancelUpdate 方法示例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="dc7bf-102">Update and CancelUpdate methods example (VC++)</span></span>


<span data-ttu-id="dc7bf-103">**适用于**： Access 2013 |Office 2013</span><span class="sxs-lookup"><span data-stu-id="dc7bf-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="dc7bf-104">以下示例演示了如何结合使用 [Update](update-method-ado.md) 方法和 [CancelUpdate](cancelupdate-method-ado.md) 方法。</span><span class="sxs-lookup"><span data-stu-id="dc7bf-104">This example demonstrates the [Update](update-method-ado.md) method in conjunction with the [CancelUpdate](cancelupdate-method-ado.md) method.</span></span>
...
<span data-ttu-id="dc7bf-105">**UpdateX.h**</span><span class="sxs-lookup"><span data-stu-id="dc7bf-105">**UpdateX.h**</span></span>
