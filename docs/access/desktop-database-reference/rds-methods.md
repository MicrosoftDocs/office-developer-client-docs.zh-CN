...
<td><p>用于移动到指定的 <strong>Recordset</strong> 对象中的第一个、最后一个、下一个或上一个记录。</p></td>
</tr>
<tr class="odd">
<td><p><a href="query-method-rds.md">查询 (RDS)</a></p></td>
<td><p>使用有效的 SQL 查询字符串返回 <strong>Recordset</strong>。</p></td>
</tr>
<tr class="even">
<td><p><a href="refresh-method-rds.md">刷新 (RDS)</a></p></td>
<td><p>可重新查询在 <strong>Connect</strong> 属性中指定的数据源并更新查询结果。</p></td>
</tr>
<tr class="odd">
<td><p><a href="reset-method-rds.md">重置 (RDS)</a></p></td>
<td><p>对客户端<strong>Recordset</strong>，基于指定的排序和筛选属性执行排序或筛选。</p></td>
</tr>
<tr class="even">
<td><p><a href="submitchanges-method-rds.md">SubmitChanges (RDS)</a></p></td>
<td><p>将缓存在本地并且可更新的 <strong>Recordset</strong> 的挂起更改提交到 <strong>Connect</strong> 属性中指定的数据源。</p></td>
</tr>
</tbody>
</table>
