...
通过发出 **Recordset** 和 [Connection](recordset-object-ado.md) 对象的 [QueryInterface](connection-object-ado.md) 来获取 **IConnectionPointContainer** 和 **IConnectionPoint** 接口，以便通知事件处理程序可用。然后对每个类发出 **IConnectionPoint::Advise** 。
