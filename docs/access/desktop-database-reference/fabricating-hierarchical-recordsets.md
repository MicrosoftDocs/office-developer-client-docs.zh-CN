...
<span data-ttu-id="1d5a2-107">构建完**Recordset**后, 可以对其进行填充、操作或将其保存到文件中。</span><span class="sxs-lookup"><span data-stu-id="1d5a2-107">After the **Recordset** has been fabricated, it can be populated, manipulated, or persisted to a file.</span></span>
