...
<span data-ttu-id="8ce1e-107">**记录集**具有构建后，它可以填充、 操作，或保存到文件。</span><span class="sxs-lookup"><span data-stu-id="8ce1e-107">After the **Recordset** has been fabricated, it can be populated, manipulated, or persisted to a file.</span></span>
