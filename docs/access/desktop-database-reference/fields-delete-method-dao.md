...
---
# <a name="fieldsdelete-method-dao"></a>Fields 方法 (DAO)

**适用于**：Access 2013、Office 2013

从 **[Fields](field-object-dao.md)** 集合中删除 **[Field](fields-collection-dao.md)** 。
...
删除已存储的对象会立即发生，但是，对于受数据库结构更改影响的其他任何集合，应使用 **Refresh** 方法。
