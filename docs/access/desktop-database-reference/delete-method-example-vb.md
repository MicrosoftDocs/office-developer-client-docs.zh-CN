...
ms.locfileid: "25860243"
---
# <a name="delete-method-example-vb"></a><span data-ttu-id="acf87-102">Delete 方法示例 (VB)</span><span class="sxs-lookup"><span data-stu-id="acf87-102">Delete method example (VB)</span></span>


<span data-ttu-id="acf87-103">**适用于**： Access 2013 |Office 2013</span><span class="sxs-lookup"><span data-stu-id="acf87-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="acf87-104">本示例使用 [Delete](delete-method-ado-recordset.md) 方法从 [Recordset](recordset-object-ado.md) 中删除指定的记录。</span><span class="sxs-lookup"><span data-stu-id="acf87-104">This example uses the [Delete](delete-method-ado-recordset.md) method to remove a specified record from a [Recordset](recordset-object-ado.md).</span></span>
