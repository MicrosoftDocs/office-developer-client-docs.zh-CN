---
title: rds.datacontrol 属性、方法和事件 (RDS)
...
ms.locfileid: "32294495"
---
# <a name="datacontrol-properties-methods-and-events-rds"></a>rds.datacontrol 属性、方法和事件 (RDS)
...
- [SQL 属性 (RDS)](https://docs.microsoft.com/office/vba/access/concepts/miscellaneous/sql-property-ado)
...
- [OnError 事件](onerror-event-rds.md)
- [OnReadyStateChange 事件](onreadystatechange-event-rds.md)
