...
ms.locfileid: "32308377"
---
# <a name="update-and-cancelupdate-methods-example-vj"></a><span data-ttu-id="fc2b2-102">Update 和 CancelUpdate 方法示例 (VJ++)</span><span class="sxs-lookup"><span data-stu-id="fc2b2-102">Update and CancelUpdate methods example (VJ++)</span></span>


<span data-ttu-id="fc2b2-103">**适用于**：Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="fc2b2-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="fc2b2-104">以下示例演示了如何结合使用 [Update](update-method-ado.md) 方法和 [CancelUpdate](cancelupdate-method-ado.md) 方法。</span><span class="sxs-lookup"><span data-stu-id="fc2b2-104">This example demonstrates the [Update](update-method-ado.md) method in conjunction with the [CancelUpdate](cancelupdate-method-ado.md) method.</span></span>
