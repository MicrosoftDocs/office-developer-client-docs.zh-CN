...
ms.locfileid: "32291595"
---
# <a name="indexes-append-method-example-vc"></a><span data-ttu-id="03fe8-102">Indexes 的 Append 方法示例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="03fe8-102">Indexes Append method example (VC++)</span></span>


<span data-ttu-id="03fe8-103">**适用于**：Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="03fe8-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="03fe8-p101">下面的代码示例演示如何创建新索引。该索引针对表中的两列而编制。</span><span class="sxs-lookup"><span data-stu-id="03fe8-p101">The following code demonstrates how to create a new index. The index is on two columns in the table.</span></span>
