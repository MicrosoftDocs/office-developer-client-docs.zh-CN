...
---
# <a name="workspacedefaultcursordriver-property-dao"></a>Workspace.DefaultCursorDriver 属性 (DAO)
...
可以将该设置值或返回值设置为 **[CursorDriverEnum](cursordriverenum-enumeration-dao.md)** 常量之一。
