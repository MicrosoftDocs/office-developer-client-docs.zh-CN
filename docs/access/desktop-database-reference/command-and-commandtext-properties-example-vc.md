...
ms.locfileid: "32296176"
---
# <a name="command-and-commandtext-properties-example-vc"></a><span data-ttu-id="6505b-102">Command 和 CommandText 属性示例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="6505b-102">Command and CommandText properties example (VC++)</span></span>


<span data-ttu-id="6505b-103">**适用于**：Access 2013、Office 2013</span><span class="sxs-lookup"><span data-stu-id="6505b-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="6505b-104">下面的代码演示如何使用 [Command](command-property-adox.md) 属性更新过程的文本。</span><span class="sxs-lookup"><span data-stu-id="6505b-104">The following code demonstrates how to use the [Command](command-property-adox.md) property to update the text of a procedure.</span></span>
