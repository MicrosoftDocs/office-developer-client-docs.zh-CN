...
**适用于**： Access 2013、 Office 2013
  ...
  - [ADCPROP\_ASYNCTHREADPRIORITY\_枚举](adcprop-asyncthreadpriority-enum.md)

  - [ADCPROP\_AUTORECALC\_枚举](adcprop-autorecalc-enum.md)

  - [ADCPROP\_UPDATECRITERIA\_枚举](adcprop-updatecriteria-enum.md)

  - [ADCPROP\_UPDATERESYNC\_枚举](adcprop-updateresync-enum.md)
