...
---
# <a name="find-method-example-vj"></a>Find 方法示例 (VJ++)


**适用于**：Access 2013、Office 2013

本示例使用 [Recordset](recordset-object-ado.md) 对象的 [Find](find-method-ado.md) 方法来查找 ***Pubs*** 数据库中的职务并统计它们的数量。 本示例假设基础提供程序不支持类似功能。
