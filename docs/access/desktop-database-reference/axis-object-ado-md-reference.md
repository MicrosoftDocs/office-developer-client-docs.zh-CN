...
ms.locfileid: "28705132"
---
# <a name="axis-object-ado-md-reference"></a>Axis 对象 （ADO MD 参考 （英文）

**适用于**： Access 2013、 Office 2013

- [Axis 对象 (ADO MD)](axis-object-ado-md.md)
- [轴属性、 方法和事件 (ADO MD)](axis-properties-methods-and-events-ado-md.md)
