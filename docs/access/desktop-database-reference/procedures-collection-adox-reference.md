...
ms.locfileid: "28707393"
---
# <a name="procedures-collection-adox-reference"></a>过程集合 (ADOX) 参考 （英文）

**适用于**： Access 2013、 Office 2013

- [Procedures 集合 (ADOX)](procedures-collection-adox.md)
- [Procedures 集合的属性、方法和事件 (ADOX)](procedures-collection-properties-methods-and-events-adox.md)
