...
---
# <a name="converttostring-method-example-vb"></a><span data-ttu-id="a52c9-102">ConvertToString 方法示例 (VB)</span><span class="sxs-lookup"><span data-stu-id="a52c9-102">ConvertToString method example (VB)</span></span>


<span data-ttu-id="a52c9-103">**适用于**： Access 2013、 Office 2013</span><span class="sxs-lookup"><span data-stu-id="a52c9-103">**Applies to**: Access 2013, Office 2013</span></span>
