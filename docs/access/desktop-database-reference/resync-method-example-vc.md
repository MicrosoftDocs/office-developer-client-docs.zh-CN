...
ms.locfileid: "25465742"
---
# <a name="resync-method-example-vc"></a><span data-ttu-id="4d311-102">Resync 方法示例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="4d311-102">Resync Method Example (VC++)</span></span>


<span data-ttu-id="4d311-103">**适用于**： Access 2013 |Office 2013</span><span class="sxs-lookup"><span data-stu-id="4d311-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="4d311-104">以下示例演示了如何使用 [Resync](resync-method-ado.md) 方法刷新静态记录集中的数据。</span><span class="sxs-lookup"><span data-stu-id="4d311-104">This example demonstrates using the [Resync](resync-method-ado.md) method to refresh data in a static recordset.</span></span>
