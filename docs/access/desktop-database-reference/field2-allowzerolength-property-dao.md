...
---
# <a name="field2allowzerolength-property-dao"></a>Field2 字符串属性 (DAO)


**适用于**：Access 2013、Office 2013


设置或返回一个值, 该值指示零长度字符串 ("") 是否为具有文本或备注数据类型的**Field2**对象的**[value](field-value-property-dao.md)** 属性的有效设置 (仅适用于 Microsoft Access 工作区)。
