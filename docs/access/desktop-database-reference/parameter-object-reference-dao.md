...
---
# <a name="parameter-object-reference-dao"></a>Parameter 对象引用 (DAO)

**适用于**：Access 2013、Office 2013

- [Parameter 对象 (DAO)](parameter-object-dao.md)
- [参数成员 (DAO)](parameter-members-dao.md)
- [参数属性 (DAO)](parameter-properties-dao.md)
