...
<<<<<<< 头匿名 Web 服务器帐户 (IUSR\_*ComputerName*) 必须添加到 Guests 本地组的 Web 服务器计算机上才能使用 rds。

<a name="to-grant-guest-privileges-to-a-web-server-computer"></a>**授予 Web 服务器计算机来宾权限的方法**
=======
