...
---
# <a name="procedure-object-adox-reference"></a>Procedure 对象 (ADOX) 引用

**适用于**：Access 2013、Office 2013

- [Procedure 对象 (ADOX)](procedure-object-adox.md)
- [过程属性、方法和事件 (ADOX)](procedure-properties-methods-and-events-adox.md)
