---
<<<<<<< 标头标题： CursorType、 LockType 和 EditMode 属性示例 （VC + +） TOCTitle: CursorType、 LockType 和 EditMode 属性示例 （VC + +） === 标题： CursorType、 LockType 和 EditMode 属性示例 （VC + +）TOCTitle: CursorType、 LockType 和 EditMode 属性示例 （VC + +）
>>>>>>> 母版页 ms:assetid: edbc4625-5013-cfcd-d709-ac8a85fe17b4 ms:mtpsurl: https://msdn.microsoft.com/library/JJ250205(v=office.15) ms:contentKeyID: 48548545 ms.date: 09/18/2015 mtps_version: office.15.aspx
---
