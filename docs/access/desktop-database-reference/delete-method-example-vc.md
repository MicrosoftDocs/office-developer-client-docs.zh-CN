...
---
# <a name="delete-method-example-vc"></a><span data-ttu-id="36832-102">Delete 方法示例 (VC++)</span><span class="sxs-lookup"><span data-stu-id="36832-102">Delete method example (VC++)</span></span>


<span data-ttu-id="36832-103">**适用于**： Access 2013、 Office 2013</span><span class="sxs-lookup"><span data-stu-id="36832-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="36832-104">本示例使用 [Delete](delete-method-ado-recordset.md) 方法从 [Recordset](recordset-object-ado.md) 中删除指定的记录。</span><span class="sxs-lookup"><span data-stu-id="36832-104">This example uses the [Delete](delete-method-ado-recordset.md) method to remove a specified record from a [Recordset](recordset-object-ado.md).</span></span>
...
<span data-ttu-id="36832-105">**DeleteX.h**</span><span class="sxs-lookup"><span data-stu-id="36832-105">**DeleteX.h**</span></span>
