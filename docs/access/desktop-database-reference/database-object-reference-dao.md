...
---
# <a name="database-object-reference-dao"></a>数据库对象引用 (DAO)

**适用于**： Access 2013、 Office 2013

- [Database 对象 (DAO)](database-object-dao.md)
- [数据库成员 (DAO)](database-members-dao.md)
- [数据库属性 (DAO)](database-properties-dao.md)
- [数据库方法 (DAO)](database-methods-dao.md)
