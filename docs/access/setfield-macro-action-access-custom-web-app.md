...
---
# <a name="setfield-macro-action-access-custom-web-app"></a>SetField 宏操作 (Access 自定义 web 应用程序)
...
|**值** <br/> |一个表达式, 指定要分配给字段的值。  <br/> |
   
## <a name="remarks"></a>注解

无法在**[CreateRecord](createrecord-data-block-access-custom-web-app.md)** 或**[EditRecord](editrecord-data-block-access-custom-web-app.md)** 数据块外部使用**SetField**操作。 
