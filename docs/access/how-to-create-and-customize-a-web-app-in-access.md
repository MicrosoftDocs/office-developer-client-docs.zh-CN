...
3. 在“您想跟踪什么?”**** 框中键入“Issues”，**** 然后按 ENTER。 
...
“客户”**** 字段与“客户”**** 表相关。要检查关系，依次选择“客户”**** 字段和“修改查找”****。此时将显示“查找向导”****，如图 2 中所示。 
...
“打开者”****、“分配到”**** 和“更改者”**** 字段均与“员工”**** 表有关。多个其他字段也设置为“查找”**** 数据类型。在这种情况下，“查找”数据类型用于指定字段中允许的特定值。 
...
应用程序将打开“问题”表的“问题列表”**** 视图。在添加问题之前，最好添加一些客户和员工。单击“客户”**** 窗格以开始添加客户。 
