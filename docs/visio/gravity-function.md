...
| _limit1_ <br/> |可选  <br/> |**字符串** <br/> |第一个旋转限制条件。默认值为 90 度。  <br/> |
...
如果 angle 介于 limit1 和 _limit2_ 指定的值之间，则返回的值为 _180_ 度;否则返回的值为 0 度。
...
如果 angle 在 90 到 270 度之间，则返回 180 度; 否则，返回 0 度。 
