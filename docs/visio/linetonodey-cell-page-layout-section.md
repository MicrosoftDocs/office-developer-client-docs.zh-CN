...
---
# <a name="linetonodey-cell-page-layout-section"></a>LineToNodeY 单元格（“Page Layout”部分）
...
|||
|:-----|:-----|
| 单元格名称：  <br/> | LineToNodeY  <br/> |
   
若要从某个程序按索引获取对 LineToNodeY 单元格的引用，请使用带下列参数的 **CellsSRC** 属性： 
  
|||
|:-----|:-----|
| 内容索引：  <br/> |**visSectionObject** <br/> |
| 行索引：  <br/> |**visRowPageLayout** <br/> |
| 单元格索引：  <br/> |**visPLOLineToNodeY** <br/> |
