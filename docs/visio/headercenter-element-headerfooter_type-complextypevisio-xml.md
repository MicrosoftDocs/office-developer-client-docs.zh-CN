...
---
# <a name="headercenter-element-headerfooter_type-complextype-visio-xml"></a>HeaderCenter 元素 (HeaderFooter_Type COMPLEXType)  (Visio XML) 
...
|||
|:-----|:-----|
|**元素类型** <br/> |[HeaderCenter_Type](headercenter_type-complextypevisio-xml.md) <br/> |
