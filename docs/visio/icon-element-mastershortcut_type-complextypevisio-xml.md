...
---
# <a name="icon-element-mastershortcuttype-complextype-visio-xml"></a>图标元素 （MasterShortcut_Type 复杂类型） (Visio XML)

文档中的 MasterShortcut 元素指定的 MIME （多用途 Internet 邮件扩展） 编码二进制图标 （.ico 格式）。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[MasterShortcut](mastershortcut-element-masters_type-complextypevisio-xml.md) <br/> |[MasterShortcut_Type](mastershortcut_type-complextypevisio-xml.md) <br/> |指定未使用的主控形状格式。  <br/> |
