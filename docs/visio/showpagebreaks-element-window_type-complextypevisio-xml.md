...
---
# <a name="showpagebreaks-element-window_type-complextype-visio-xml"></a>ShowPageBreaks 元素 (Window_Type COMPLEXType)  (Visio XML) 
...
|||
|:-----|:-----|
|**元素类型** <br/> |[ShowPageBreaks_Type](showpagebreaks_type-complextypevisio-xml.md) <br/> |
