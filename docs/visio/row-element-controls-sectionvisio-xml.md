...
---
# <a name="row-element-controls-section-visio-xml"></a>Row 元素 (Controls Section)  (Visio XML) 
...
|||
|:-----|:-----|
|**元素类型** <br/> |[ControlRow_Type](controlrow_type-complextypevisio-xml.md) <br/> |
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |包含为形状定义的特定控制手柄的单元格。  <br/> |
   
### <a name="child-elements"></a>子元素

|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Cell](cell-element-controls-rowvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |包含为形状定义的特定控制手柄的属性。  <br/> |
