...
---
# <a name="issuestype-complextype-visio-xml"></a>Issues_Type 复杂类型 (Visio XML)
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[问题](issue-element-issues_type-complextypevisio-xml.md) <br/> |[Issue_Type](issue_type-complextypevisio-xml.md) <br/> ||
