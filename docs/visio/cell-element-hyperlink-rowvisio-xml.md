...
包含与形状相关联的单个超链接的信息。 形状将包含每个 **超链接的一** 个 Hyperlink 行。 
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Row 元素 (Hyperlink Section) ](row-element-hyperlink-sectionvisio-xml.md) <br/> |[HyperlinkRow_Type](hyperlinkrow_type-complextypevisio-xml.md) <br/> |包含与形状相关联的单个超链接的信息。 形状将包含每个 **超链接的一** 个 Hyperlink 行。  <br/> |
...
|**值**|**说明**|**详细信息**|
|:-----|:-----|:-----|
|地址  <br/> |指定要跳转到的 URL 地址、文件名或 UNC 路径。  <br/> |[Address Cell (Hyperlinks Section)](address-cell-hyperlinks-section.md) <br/> |
