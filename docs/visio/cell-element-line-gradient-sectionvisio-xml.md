...
---
# <a name="cell-element-line-gradient-section-visio-xml"></a>Cell 元素 ("线条渐变" 部分) ("Visio XML")

包含线条渐变的渐变停止点的颜色、透明度或位置。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Row 元素 ("线条渐变" 部分)](row-element-line-gradient-sectionvisio-xml.md) <br/> |[LineGradientRow_Type](linegradientrow_type-complextypevisio-xml.md) <br/> |包含颜色、透明度以及线条渐变的渐变停止点的位置。  <br/> |
...
|**Value**|**说明**|**详细信息**|
|:-----|:-----|:-----|
|GradientStopColor  <br/> |渐变光圈的颜色值。  <br/> |[渐变停止行 ("线条渐变" 部分)](gradient-stop-row-line-gradient-section.md) <br/> |
|GradientStopColorTrans  <br/> |梯度停止点颜色的透明度, 以百分比表示。  <br/> |[渐变停止行 ("线条渐变" 部分)](gradient-stop-row-line-gradient-section.md) <br/> |
|GradientStopPosition  <br/> |渐变光圈沿直线渐变的方向, 作为从渐变原点到渐变边缘的百分比表示的相对位置。  <br/> |[渐变停止行 ("线条渐变" 部分)](gradient-stop-row-line-gradient-section.md) <br/> |
