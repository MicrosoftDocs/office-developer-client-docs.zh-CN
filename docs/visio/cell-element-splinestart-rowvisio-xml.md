...
---
# <a name="cell-element-splinestart-row-visio-xml"></a>SplineStart (XML)  (Visio的 Cell 元素) 

包含样条的第二个控制点、其第二个节点、第一个节点、最后一个节点或样条的度数的 x 或 y 坐标。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Geometry (Row) ](row-element-geometry-sectionvisio-xml.md) <br/> |[SplineStart_Type](splinestart_type-complextypevisio-xml.md) <br/> |包含样条的第二个控制点、其第二个节点、第一个节点、最后一个节点或样条的度数的 x 或 y 坐标。  <br/> |
...
|C  <br/> |样条的最后一个节点。  <br/> |[RelEllipticalArcTo "Geometry" (行) ](splinestart-row-geometry-section.md) <br/> |
