...
---
# <a name="cp-element-text_type-complextype-visio-xml"></a>cp 元素 (Text_Type complexType)  (Visio XML) 

标记根据相应的 Char 元素设置格式的字符属性的开头。 运行定义到文本的末尾或直到下一个标记。
...
|**属性**|**类型**|**必需**|**描述**|**可能的值**|
|:-----|:-----|:-----|:-----|:-----|
|IX  <br/> |xsd：unsignedInt  <br/> |必需  <br/> |此属性运行表示的 Char 元素索引。  <br/> |xsd：unsignedInt 类型的值。  <br/> |
