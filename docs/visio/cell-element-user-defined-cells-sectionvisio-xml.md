...
---
# <a name="cell-element-user-defined-cells-section-visio-xml"></a>User-defined Cells (的 Cell 元素)  (Visio XML) 

用户指定的信息块的一个属性，其他单元格和加载项工具可以引用这些信息。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Row 元素 (User-defined Cells Section) ](row-element-user-defined-cells-sectionvisio-xml.md) <br/> |[UserRow_Type](userrow_type-complextypevisio-xml.md) <br/> |用户指定的信息块的一个属性，其他单元格和加载项工具可以引用这些信息。  <br/> |
...
|**值**|**说明**|**详细信息**|
|:-----|:-----|:-----|
|Prompt  <br/> |为用户定义的单元格指定说明性提示或注释。  <br/> |[Prompt Cell (User-Defined Cells Section)](prompt-cell-user-defined-cells-section.md) <br/> |
|值  <br/> |为相应的用户定义的单元格指定值。  <br/> |[Value Cell (User-Defined Cells Section)](value-cell-user-defined-cells-section.md) <br/> |
