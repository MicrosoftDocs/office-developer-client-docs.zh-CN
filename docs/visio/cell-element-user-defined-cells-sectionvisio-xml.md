...
---
# <a name="cell-element-user-defined-cells-section-visio-xml"></a>单元格元素 （用户定义的单元格部分） (Visio XML)

用户指定的可由其他单元格和加载项工具引用的信息片段一个属性。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Row 元素（“User-defined Cells”部分）](row-element-user-defined-cells-sectionvisio-xml.md) <br/> |[UserRow_Type](userrow_type-complextypevisio-xml.md) <br/> |用户指定的可由其他单元格和加载项工具引用的信息片段一个属性。  <br/> |
...
|**值**|**说明**|**更多信息**|
|:-----|:-----|:-----|
|提示  <br/> |为用户定义的单元格指定说明性提示或注释。  <br/> |[Prompt Cell (User-Defined Cells Section)](prompt-cell-user-defined-cells-section.md) <br/> |
