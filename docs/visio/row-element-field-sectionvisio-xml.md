...
---
# <a name="row-element-field-section-visio-xml"></a>Row 元素 ("Field" 内容) ("Visio XML")
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Cell](cell-element-field-sectionvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |使用 "域" 对话框显示在形状的文本中插入的函数和公式  <br/> |
