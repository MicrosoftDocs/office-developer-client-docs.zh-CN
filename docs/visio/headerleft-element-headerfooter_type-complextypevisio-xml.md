...
---
# <a name="headerleft-element-headerfootertype-complextype-visio-xml"></a>HeaderLeft 元素 (HeaderFooter_Type 复杂类型) ("Visio XML")
...
|||
|:-----|:-----|
|**元素类型** <br/> |[HeaderLeft_Type](headerleft_type-complextypevisio-xml.md) <br/> |
