...
description: Visio 2013 ShapeSheet 参考 （英文） 此部分包含以下部分：
ms.openlocfilehash: 268589b641b20ed1b4d36f9c85e2b2aac4a8b738
ms.sourcegitcommit: 9d60cd82b5413446e5bc8ace2cd689f683fb41a7
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 06/11/2018
ms.locfileid: "19781033"
---
# <a name="reference-visio-shapesheet"></a>参考 （英文） (Visio ShapeSheet)

Visio 2013 ShapeSheet 参考 （英文） 此部分包含以下部分：
