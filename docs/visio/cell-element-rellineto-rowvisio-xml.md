...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Row 元素 （geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[RelLineTo_Type](rellineto_type-complextypevisio-xml.md) <br/> |包含 x-或相对于形状的宽度和高度直线段终顶点的 y 坐标。  <br/> |
...
|**值**|**说明**|**更多信息**|
|:-----|:-----|:-----|
|X  <br/> |相对于形状的宽度直线段终顶点的 x 坐标。  <br/> |[RelLineTo 行（“Geometry”部分）](rellineto-row-geometry-section.md) <br/> |
|Y  <br/> |相对于形状的高度直线段终顶点的 y 坐标。  <br/> |[RelLineTo 行（“Geometry”部分）](rellineto-row-geometry-section.md) <br/> |
