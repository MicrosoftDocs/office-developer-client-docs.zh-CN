...
包含相对于形状的宽度和高度的直线段终顶点的 x 坐标或 y 坐标。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Row 元素 ("几何")](row-element-geometry-sectionvisio-xml.md) <br/> |[RelLineTo_Type](rellineto_type-complextypevisio-xml.md) <br/> |包含相对于形状的宽度和高度的直线段终顶点的 x 坐标或 y 坐标。  <br/> |
...
|**值**|**说明**|**详细信息**|
|:-----|:-----|:-----|
|X  <br/> |直线线段终顶点相对于形状宽度的 x 坐标。  <br/> |[RelLineTo 行 ("Geometry" 部分)](rellineto-row-geometry-section.md) <br/> |
|Y  <br/> |直线线段终顶点相对于形状高度的 y 轴坐标值。  <br/> |[RelLineTo 行 ("Geometry" 部分)](rellineto-row-geometry-section.md) <br/> |
