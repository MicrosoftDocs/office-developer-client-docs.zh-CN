...
---
# <a name="cell-element-rellineto-row-visio-xml"></a>Cell 元素 (RelLineTo 行)  (Visio XML) 

包含直线段终顶点相对于形状的宽度和高度的 x 或 y 坐标。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Geometry (Row) ](row-element-geometry-sectionvisio-xml.md) <br/> |[RelLineTo_Type](rellineto_type-complextypevisio-xml.md) <br/> |包含直线段终顶点相对于形状的宽度和高度的 x 或 y 坐标。  <br/> |
...
|**值**|**说明**|**详细信息**|
|:-----|:-----|:-----|
|X  <br/> |直线段终顶点相对于形状宽度的 x 坐标。  <br/> |[RelLineTo Row (Geometry Section) ](rellineto-row-geometry-section.md) <br/> |
|Y  <br/> |直线段终顶点相对于形状高度的 y 坐标。  <br/> |[RelLineTo Row (Geometry Section) ](rellineto-row-geometry-section.md) <br/> |
