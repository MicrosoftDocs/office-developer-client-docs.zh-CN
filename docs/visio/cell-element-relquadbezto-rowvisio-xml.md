...
包含二次方贝塞尔曲线终点相对于形状的宽度和高度的 x 坐标或 y 坐标，或者曲线相对形状的宽度和高度的控制点的 x 坐标或 y 坐标。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Geometry (Row) ](row-element-geometry-sectionvisio-xml.md) <br/> |[RelQuadBezTo_Type](relquadbezto_type-complextypevisio-xml.md) <br/> |包含二次方贝塞尔曲线终点相对于形状的宽度和高度的 x 坐标或 y 坐标，或者曲线相对形状的宽度和高度的控制点的 x 坐标或 y 坐标。  <br/> |
...
|**值**|**说明**|**详细信息**|
|:-----|:-----|:-----|
|X  <br/> |二次方贝塞尔曲线的终顶点相对于形状宽度的 x 坐标。  <br/> |[RelQuadBezTo Row (Geometry Section) ](relquadbezto-row-geometry-section.md) <br/> |
|Y  <br/> |二次方贝塞尔曲线的终顶点相对于形状高度的 y 坐标。  <br/> |[RelQuadBezTo Row (Geometry Section) ](relquadbezto-row-geometry-section.md) <br/> |
|A  <br/> |曲线控制点相对于形状宽度的 x 坐标;弧形上的点。控制点最好位于弧形的开始顶点和结束顶点之间的一半左右。  <br/> |[RelQuadBezTo Row (Geometry Section) ](relquadbezto-row-geometry-section.md) <br/> |
|B  <br/> |曲线控制点相对于形状高度的 y 坐标。  <br/> |[RelQuadBezTo Row (Geometry Section) ](relquadbezto-row-geometry-section.md) <br/> |
