...
---
# <a name="cell-element-arcto-row-visio-xml"></a>ArcTo (XML)  (Visio中的 Cell 元素) 
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Geometry (Row) ](row-element-geometry-sectionvisio-xml.md) <br/> |[ArcTo_Type](arcto_type-complextypevisio-xml.md) <br/> |包含圆弧的 x 坐标、y 坐标和弓。  <br/> |
   
### <a name="child-elements"></a>子元素

|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[RefBy](refby-element-cell_type-complextypevisio-xml.md) <br/> |[RefBy_Type](refby_type-complextypevisio-xml.md) <br/> |包含圆弧的 x 坐标、y 坐标或弓形。  <br/> |
...
|Y  <br/> |弧形终顶点的 y 坐标。  <br/> |[ArcTo Row (Geometry Section)](arcto-row-geometry-section.md) <br/> |
