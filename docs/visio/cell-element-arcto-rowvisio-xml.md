...
---
# <a name="cell-element-arcto-row-visio-xml"></a>Cell 元素 ("ArcTo" 行) ("Visio XML")
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Row 元素 ("几何")](row-element-geometry-sectionvisio-xml.md) <br/> |[ArcTo_Type](arcto_type-complextypevisio-xml.md) <br/> |包含圆弧的 x 坐标、y 坐标和弓。  <br/> |
   
### <a name="child-elements"></a>子元素

|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[RefBy](refby-element-cell_type-complextypevisio-xml.md) <br/> |[RefBy_Type](refby_type-complextypevisio-xml.md) <br/> |包含 x 坐标、y 坐标或圆弧的曲线。  <br/> |
