...
---
# <a name="snapextensions-element-window_type-complextype-visio-xml"></a>SnapExtensions 元素 (Window_Type complexType)  (Visio XML) 

指定是启用还是禁用活动窗口的特定对齐扩展设置。 值可以是下表中值的总和。
