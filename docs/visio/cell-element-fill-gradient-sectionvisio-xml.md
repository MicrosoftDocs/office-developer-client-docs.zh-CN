...
---
# <a name="cell-element-fill-gradient-section-visio-xml"></a>Cell 元素 (Fill Gradient Section)  (Visio XML) 
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[FillGradient (Row 元素) ](row-element-fill-gradient-sectionvisio-xml.md) <br/> |[FillGradientRow_Type](fillgradientrow_type-complextypevisio-xml.md) <br/> |包含填充渐变的渐变停点的颜色、透明度以及位置。  <br/> |
...
|**值**|**说明**|**详细信息**|
|:-----|:-----|:-----|
|GradientStopColor  <br/> |渐变停点的颜色值。 此值可以表示为文档调色板中颜色的索引号，或者使用 **RGB、THEMEVAL** 或 **HSL** 函数表示。  <br/> |[Gradient Stop Row (Fill Gradient Section) ](gradient-stop-row-fill-gradient-section.md) <br/> |
|GradientStopColorTrans  <br/> |渐变颜色停止点的透明度，以百分比表示。  <br/> |[Gradient Stop Row (Fill Gradient Section) ](gradient-stop-row-fill-gradient-section.md) <br/> |
|GradientStopPosition  <br/> |渐变停点沿线条渐变方向的位置，以从渐变原点到渐变外边缘的百分比表示。  <br/> |[Gradient Stop Row (Fill Gradient Section) ](gradient-stop-row-fill-gradient-section.md) <br/> |
