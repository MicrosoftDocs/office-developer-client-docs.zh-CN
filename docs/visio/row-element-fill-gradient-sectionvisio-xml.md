...
---
# <a name="row-element-fill-gradient-section-visio-xml"></a>Row 元素 （填充渐变部分） (Visio XML)
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |包含颜色、 透明度和渐变填充的渐变光圈的位置。  <br/> |
