...
|**名称**|**必需/可选**|**数据类型**|**说明**|
|:-----|:-----|:-----|:-----|
| _expression_ <br/> |必需  <br/> |**变化** <br/> |文档颜色表中颜色的索引、解析为自定义颜色 (如 RGB 或 HSL) 的表达式，或对包含颜色索引或颜色结果的单元格的引用。  <br/> |
...
返回值是 0 至 255（包括 0 和 255）之间的数字，或解析为索引值的单元格引用。 如果  *expression*  无效，它将返回 0 (黑色) 。 
