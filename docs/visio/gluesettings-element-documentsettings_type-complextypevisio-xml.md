...
---
# <a name="gluesettings-element-documentsettings_type-complextype-visio-xml"></a>GlueSettings 元素 (DocumentSettings_Type COMPLEXType)  (Visio XML) 
...
|||
|:-----|:-----|
|**元素类型** <br/> |[GlueSettings_Type](gluesettings_type-complextypevisio-xml.md) <br/> |
