...
|**名称**|**必需/可选**|**数据类型**|**说明**|
|:-----|:-----|:-----|:-----|
| _point_ <br/> |必需  <br/> |**Number, Number** <br/> |用当前形状的坐标系表示的点的坐标。  <br/> |
   
## <a name="remarks"></a>备注

在 Microsoft Visio 中，点是包含 *一对 x* 坐标和 *y* 坐标的单个值。 如果形状在一个组合中，则它的父级就是该组合。 如果形状不在一个组合中，则它的父级是页。 
