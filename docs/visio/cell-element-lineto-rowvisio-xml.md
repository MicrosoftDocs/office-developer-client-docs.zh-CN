...
---
# <a name="cell-element-lineto-row-visio-xml"></a>单元格元素 （LineTo 行） (Visio XML)
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Row 元素 （geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[LineTo_Type](lineto_type-complextypevisio-xml.md) <br/> |包含 x-或直线段终顶点的 y 坐标。  <br/> |
