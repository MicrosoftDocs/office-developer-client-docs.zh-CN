...
---
# <a name="texttype-complextype-visio-xml"></a>Text_Type 复杂类型 (Visio XML)
...
|[文件夹](fld-element-text_type-complextypevisio-xml.md) <br/> |[fld_Type](fld_type-complextypevisio-xml.md) <br/> ||
