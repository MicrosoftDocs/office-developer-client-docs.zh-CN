...
---
# <a name="row-element-hyperlink-section-visio-xml"></a>Row 元素 ("超链接" 部分) ("Visio XML")

包含用于在形状或绘图页与其他绘图页、另一个文件或网站之间创建多个跳转的元素。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |包含用于在形状或绘图页与其他绘图页、另一个文件或网站之间创建多个跳转的元素。  <br/> |
