...
---
# <a name="row-element-scratch-section-visio-xml"></a>Row 元素 ("草稿" 部分) ("Visio XML")
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Cell](cell-element-scratch-sectionvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |指定一个属性。  <br/> |
