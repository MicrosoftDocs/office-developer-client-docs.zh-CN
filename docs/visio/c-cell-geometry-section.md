...
|Row|说明|
|:-----|:-----|
|[EllipticalArcTo](ellipticalarcto-row-geometry-section.md) <br/> | 弧形主轴相对于其父级  *的 x*  轴的角度。  <br/> |
...
|[Ellipse](ellipse-row-geometry-section.md) <br/> | 椭圆上点的 *x* 坐标;与 D 单元格所代表的 *y* [坐标配对。](d-cell-geometry-section.md)  <br/> |
