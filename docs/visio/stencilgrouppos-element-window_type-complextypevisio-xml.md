---
title: 'StencilGroupPos 元素 (Window_Type COMPLEXType)  (Visio XML) '
manager: soliver
ms.date: 03/09/2015
...
description: 包含一个整数，该整数指定模具在窗口中的组内的相对位置。
ms.openlocfilehash: a539cd4435477f43a2e9c16b6a9b77e6e1e9d7f5
ms.sourcegitcommit: e7b38e37a9d79becfd679e10420a19890165606d
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 05/29/2019
ms.locfileid: "34538877"
---
# <a name="stencilgrouppos-element-window_type-complextype-visio-xml"></a>StencilGroupPos 元素 (Window_Type COMPLEXType)  (Visio XML) 

包含一个整数，该整数指定模具在窗口中的组内的相对位置。
  
## <a name="element-information"></a>元素信息

|||
|:-----|:-----|
|**元素类型** <br/> |[StencilGroupPos_Type](stencilgrouppos_type-complextypevisio-xml.md) <br/> |
