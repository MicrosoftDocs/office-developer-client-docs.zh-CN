...
|:-----|:-----|
|0  <br/> |无箭头。  <br/> |
|1-45  <br/> |与**线条**对话框中的索引项相对应的各种类型的箭头样式。  <br/> |
   
## <a name="remarks"></a>备注

您还可以在**线条**对话框来设置此值 （**主页**选项卡，在**形状**组中，单击**线条**，指向**箭头**，然后单击**其他箭头**）。 EndArrowSize 单元格中设置箭头的大小。
  
您可以使用 USE 函数在此单元格中指定自定义线端。 
  
要从另一个公式或使用**CellsU**属性从某个程序按名称获取对 EndArrow 单元格的引用，请使用： 
