---
title: 'ShowConnectionPoints 元素 (Window_Type COMPLEXType)  (Visio XML) '
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "34543008"
---
# <a name="showconnectionpoints-element-window_type-complextype-visio-xml"></a>ShowConnectionPoints 元素 (Window_Type COMPLEXType)  (Visio XML) 
...
|||
|:-----|:-----|
|**元素类型** <br/> |[ShowConnectionPoints_Type](showconnectionpoints_type-complextypevisio-xml.md) <br/> |
