---
title: 'SnapAngles 元素 (DocumentSettings_Type COMPLEXType)  (Visio XML) '
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "34540390"
---
# <a name="snapangles-element-documentsettings_type-complextype-visio-xml"></a>SnapAngles 元素 (DocumentSettings_Type COMPLEXType)  (Visio XML) 
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[SnapAngle](snapangle-element-snapangles_type-complextypevisio-xml.md) <br/> |[SnapAngle_Type](snapangle_type-complextypevisio-xml.md) <br/> |包含以度数指定吸附角度的浮点数。  <br/> |
