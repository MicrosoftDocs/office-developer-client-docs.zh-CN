...
---
# <a name="shape-data-section"></a>“Shape Data”部分
...
> [!NOTE]
> 在 Visio 以前的版本中,**形状数据**部分被称为**自定义属性**。 
  
- 在 ShapeSheet 窗口中，您可以定义形状数据**形状数据**部分中。 在 ShapeSheet 窗口中右键单击并单击**插入节**，然后选择**形状数据**复选框。 您可以添加任意多个属性。 *名称*行根据需要为这些行中，指定有意义的名称，并设置单元格的值。 
