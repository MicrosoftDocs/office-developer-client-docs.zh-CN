...
---
# <a name="cell-element-infiniteline-row-visio-xml"></a>Cell 元素 (InfiniteLine 行)  (Visio XML) 

包含无限长线上两个点的 x 坐标或 y 坐标。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Geometry (Row) ](row-element-geometry-sectionvisio-xml.md) <br/> |[InfiniteLine_Type](infiniteline_type-complextypevisio-xml.md) <br/> |包含无限长线上两个点的 x 坐标或 y 坐标。  <br/> |
...
|**值**|**说明**|**详细信息**|
|:-----|:-----|:-----|
|X  <br/> |无限长线上某个点的 x 坐标；与 Y 单元格所表示的 y 坐标配对。  <br/> |[InfiniteLine Row (Geometry Section)](infiniteline-row-geometry-section.md) <br/> |
|Y  <br/> |无限长线上某个点的 y 坐标；与 X 单元格所表示的 x 坐标配对。  <br/> |[InfiniteLine Row (Geometry Section)](infiniteline-row-geometry-section.md) <br/> |
|A  <br/> |无限长线上某个点的 x 坐标；与 B 单元格所表示的 y 坐标配对。  <br/> |[InfiniteLine Row (Geometry Section)](infiniteline-row-geometry-section.md) <br/> |
|B  <br/> |无限长线上某个点的 y 坐标；与 A 单元格所表示的 x 坐标配对。  <br/> |[InfiniteLine Row (Geometry Section)](infiniteline-row-geometry-section.md) <br/> |
