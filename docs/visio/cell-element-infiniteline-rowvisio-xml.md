...
---
# <a name="cell-element-infiniteline-row-visio-xml"></a>单元格元素 （InfiniteLine 行） (Visio XML)
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Row 元素 （geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[InfiniteLine_Type](infiniteline_type-complextypevisio-xml.md) <br/> |包含无限长线上两个点的 x 坐标或 y。  <br/> |
