...
---
# <a name="validationproperties-element-validation_type-complextype-visio-xml"></a>ValidationProperties 元素 (Validation_Type COMPLEXType)  (Visio XML) 
...
|ShowIgnored  <br/> |xsd：boolean  <br/> |必需  <br/> |指定是否在"问题"窗口中显示被忽略的验证问题。  <br/> |xsd：boolean 类型的值。  <br/> |
