---
title: 'ShowGuides 元素 (Window_Type COMPLEXType)  (Visio XML) '
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="showguides-element-window_type-complextype-visio-xml"></a>ShowGuides 元素 (Window_Type COMPLEXType)  (Visio XML) 
