...
---
# <a name="rel-element-solution_type-complextype-visio-xml"></a>Rel 元素 (Solution_Type complexType)  (Visio XML) 

指定与与此解决方案关联的解决方案 XML 的部件的关系。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Solution](solution-element-solutions_type-complextypevisio-xml.md) <br/> |[Solution_Type](solution_type-complextypevisio-xml.md) <br/> |指定绘图中存储的解决方案 XML 的一个实例。  <br/> |
