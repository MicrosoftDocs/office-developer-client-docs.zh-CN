...
---
# <a name="row-element-line-gradient-section-visio-xml"></a>Row 元素 (Line Gradient Section)  (Visio XML) 

包含线条渐变的渐变停点的颜色、透明度以及位置。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |包含线条渐变的渐变停点的颜色、透明度以及位置。  <br/> |
