...
---
# <a name="ruleinfo-element-issue_type-complextype-visio-xml"></a>RuleInfo 元素 (Issue_Type COMPLEXType)  (Visio XML) 

指定有关父验证问题所相关的验证规则的信息。
...
|**属性**|**类型**|**必需**|**描述**|**可能的值**|
|:-----|:-----|:-----|:-----|:-----|
|RuleID  <br/> |xsd：unsignedInt  <br/> |必需  <br/> |指定父问题所针对的验证规则的唯一标识符。  <br/> |xsd：unsignedInt 类型的值。  <br/> |
|RuleSetID  <br/> |xsd：unsignedInt  <br/> |必需  <br/> |指定父问题规则集验证对象的唯一标识符。  <br/> |xsd：unsignedInt 类型的值。  <br/> |
