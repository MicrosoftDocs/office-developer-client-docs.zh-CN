...
---
# <a name="cell-element-tabs-section-visio-xml"></a>"Tabs" (的 Cell 元素)  (Visio XML) 

指定控制形状和样式制表位位置或对齐方式的属性。 
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|["Tabs" (的 Row 元素) ](row-element-tabs-sectionvisio-xml.md) <br/> |[TabsRow_Type](tabsrow_type-complextypevisio-xml.md) <br/> |指定控制形状和样式制表位位置或对齐方式的属性。  <br/> |
