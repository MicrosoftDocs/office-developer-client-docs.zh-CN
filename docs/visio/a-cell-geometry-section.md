...
|[EllipticalArcTo](ellipticalarcto-row-geometry-section.md) <br/> | 弧形控制点（弧形上的一个点）的  *x*  坐标。控制点最好位于弧形的开始顶点和结束顶点之间的一半左右。否则，弧形可能会增长到极大小，以便通过控制点，从而产生不可预知的结果。  <br/> |
...
|[InfiniteLine](infiniteline-row-geometry-section.md) <br/> | 无限 *长* 线上点的 x 坐标;与 B 单元格表示的 *y* [坐标配对。](b-cell-geometry-section.md)  <br/> |
|[Ellipse](ellipse-row-geometry-section.md) <br/> | 椭圆上点的 *x* 坐标;与 B 单元格表示的 *y* [坐标配对。](b-cell-geometry-section.md)  <br/> |
...
|||
|:-----|:-----|
| 单元格名称：  <br/> | Geometry  *i*  .a  *j*            where  *i*  and  *j*  = <1>， 2， 3...  <br/> |
|| Geometry  *i*  .A1 (InfiniteLine 和 Ellipse) 其中  *i*  = <1>、2、3...  <br/> |
