...
<span data-ttu-id="05c13-124">**表 1. 操纵 Visio 2013 文件格式的核心概念**</span><span class="sxs-lookup"><span data-stu-id="05c13-124">**Table 1. Core concepts for manipulating the Visio 2013 file format**</span></span>
...
6. <span data-ttu-id="05c13-148">在画布上选择新的“流程”形状，并键入“Perform some task”。</span><span class="sxs-lookup"><span data-stu-id="05c13-148">Select the new Process shape on the drawing canvas and type 'Perform some task'.</span></span>
...
1. <span data-ttu-id="05c13-162">在**文件**菜单上选择**新建****项目**。</span><span class="sxs-lookup"><span data-stu-id="05c13-162">On the **File** menu, choose **New**, **Project**.</span></span>
...
1. <span data-ttu-id="05c13-180">在 **Program** 类（或 Visual Basic 中的 **Module1**）中的 **Main** 方法后面，添加以下代码。</span><span class="sxs-lookup"><span data-stu-id="05c13-180">After the **Main** method in the **Program** class (or **Module1** in Visual Basic), add the following code.</span></span> 
...
2. <span data-ttu-id="05c13-181">在 **Program** 类（或 Visual Basic 中的 **Module1**）中的 **Main** 方法中，添加以下代码。</span><span class="sxs-lookup"><span data-stu-id="05c13-181">In the **Main** method of the **Program** class (or **Module1** in Visual Basic), add the following code.</span></span> 
...
### <a name="to-iterate-through-the-package-parts-in-a-package"></a><span data-ttu-id="05c13-189">循环访问包中的包部件</span><span class="sxs-lookup"><span data-stu-id="05c13-189">To iterate through the package parts in a package</span></span>
...
3. <span data-ttu-id="05c13-p112">选择 F5 键以调试解决方案。该程序完成运行后，选择任意键退出。</span><span class="sxs-lookup"><span data-stu-id="05c13-p112">Choose the F5 key to debug the solution. When the program has completed running, choose any key to exit.</span></span>
...
<span data-ttu-id="05c13-264">使用以下过程从 Visio 页上的 XML 保存回页面内容部件。</span><span class="sxs-lookup"><span data-stu-id="05c13-264">Use the following procedure to save the XML from the Visio page back to the Page Contents part.</span></span>
...
3. <span data-ttu-id="05c13-315">将 **Program** 类的 **Main** 方法中的 **using** 块（在 Visual Basic 中为 **Module1** 中 **Main** 方法的 **Using** 块）中的前一示例代码替换为以下代码。</span><span class="sxs-lookup"><span data-stu-id="05c13-315">Replace the code from the previous example in the **using** block in the **Main** method of the **Program** class (the **Using** block of the **Main** method in **Module1** in Visual Basic), with the following code.</span></span> 
...
4. <span data-ttu-id="05c13-p140">选择 F5 键以调试解决方案。该程序完成运行后，选择任意键退出。</span><span class="sxs-lookup"><span data-stu-id="05c13-p140">Choose the F5 key to debug the solution. When the program has completed running, choose any key to exit.</span></span>
    
5. <span data-ttu-id="05c13-318">在 Visio 2013 中打开 Visio Package.vsdx 文件。</span><span class="sxs-lookup"><span data-stu-id="05c13-318">Open the Visio Package.vsdx file in Visio 2013.</span></span> 
    
<span data-ttu-id="05c13-p141">“开始/结束”形状现在应该距离绘图底部 2 英寸。“开始/结束”形状和“流程”形状之间的连接器应该已经重新路由以适应布局变更。如果 **RecalcDocument** 属性尚未添加到文件中，形状位置可能已更改，但连接器尚未重新路由到形状的新位置。</span><span class="sxs-lookup"><span data-stu-id="05c13-p141">The Start/End shape should now be 2 inches from the bottom edge of the drawing. The connector between the Start/End shape and the Process shape should have rerouted to accommodate the change in layout. If the **RecalcDocument** property had not been added to the file, the shape position would have been changed, but the connector would not have rerouted to the new location of the shape.</span></span> 
  
## <a name="add-a-new-package-part-to-a-package"></a><span data-ttu-id="05c13-322">向包中添加新的包部件</span><span class="sxs-lookup"><span data-stu-id="05c13-322">Add a new package part to a package</span></span>
<span data-ttu-id="05c13-323"><a name="vis15_ManipulateFF_AddNewPart"> </a></span><span class="sxs-lookup"><span data-stu-id="05c13-323"></span></span>

<span data-ttu-id="05c13-324">修改文件包的最常见方案之一将新文档部件添加到包中。</span><span class="sxs-lookup"><span data-stu-id="05c13-324">One of the most common scenarios for modifying a file package is adding a new document part to the package.</span></span> <span data-ttu-id="05c13-325">例如，如果您想要将页面添加到 Visio 绘图通过将内容添加到包，您需要将页面内容部件添加到包。</span><span class="sxs-lookup"><span data-stu-id="05c13-325">For example, if you want to add a page to the Visio drawing by adding content to the package, you need to add a Page Contents part to the package.</span></span> 
  
<span data-ttu-id="05c13-326">向文件包中添加新部件的过程非常简单：</span><span class="sxs-lookup"><span data-stu-id="05c13-326">The process for adding a new part to the package is straightforward:</span></span> 
  
1. <span data-ttu-id="05c13-p143">您使用 **PackagePart** 的数据创建 XML 文档。您需要特别注意用于管理所创建的特定 XML 文档类型的方案的 XML 命名空间。</span><span class="sxs-lookup"><span data-stu-id="05c13-p143">You create the XML document with the data for the **PackagePart**. You need to pay special attention to the XML namespaces that govern the schema for the specific type of XML document that you create.</span></span>
    
2. <span data-ttu-id="05c13-329">您创建一个新文件以包含 XML 并将文件保存到 **Package** 中的某个位置。</span><span class="sxs-lookup"><span data-stu-id="05c13-329">You create a new file to contain the XML and save the file to a location in the **Package**.</span></span>
    
3. <span data-ttu-id="05c13-330">您在新 **PackagePart** 和 **Package** 或其他 **PackagePart** 对象之间创建必要的关系。</span><span class="sxs-lookup"><span data-stu-id="05c13-330">You create the necessary relationships between the new **PackagePart** and the **Package** or other **PackagePart** objects.</span></span> 
    
4. <span data-ttu-id="05c13-p144">您更新引用新部件所需的任何现有部件。例如，如果您在文件中添加新的页面内容部件（一个新页面），则您还需要更新页面索引部件（/visio/pages/pages.xml 文件），以包含关于新页面的正确信息。</span><span class="sxs-lookup"><span data-stu-id="05c13-p144">You update any existing parts that need to reference the new part. For example, if you add a new Page Contents part (a new page) to the file, you also need to update the Page Index part (/visio/pages/pages.xml file) to include the correct information about the new page.</span></span>
    
<span data-ttu-id="05c13-333">使用以下过程在 Visio 文件中创建新的功能区可扩展部件。</span><span class="sxs-lookup"><span data-stu-id="05c13-333">Use the following procedure to create a new Ribbon Extensibility part in the Visio file.</span></span> <span data-ttu-id="05c13-334">新的功能区可扩展部件向功能区添加新选项卡与包含一个按钮的单个组。</span><span class="sxs-lookup"><span data-stu-id="05c13-334">The new Ribbon Extensibility part adds to the ribbon a new tab with a single group that contains a single button.</span></span>
  
### <a name="to-create-a-new-package-part"></a><span data-ttu-id="05c13-335">创建新的包部件</span><span class="sxs-lookup"><span data-stu-id="05c13-335">To create a new package part</span></span>

1. <span data-ttu-id="05c13-336">后`CheckForRecalc`中前面的过程中，**程序**类 （或在 Visual Basic 中的**模块 1** ） 方法添加以下方法。</span><span class="sxs-lookup"><span data-stu-id="05c13-336">After the  `CheckForRecalc` method in the **Program** class (or **Module1** in Visual Basic) from the previous procedure, add the following method.</span></span> 
...
2. <span data-ttu-id="05c13-337">后`CreateCustomUI` **Program**类 （或在 Visual Basic 中的**模块 1** ） 从上一步中方法添加以下方法。</span><span class="sxs-lookup"><span data-stu-id="05c13-337">After the  `CreateCustomUI` method in the **Program** class (or **Module1** in Visual Basic) from the previous step, add the following method.</span></span> 
...
3. <span data-ttu-id="05c13-338">将 **Program** 类的 **Main** 方法中的 **using** 块（在 Visual Basic 中为 **Module1** 中 **Main** 方法的 **Using** 块）中的所有代码替换为以下代码。</span><span class="sxs-lookup"><span data-stu-id="05c13-338">Replace all the code in the **using** block in the **Main** method of the **Program** class (the **Using** block of the **Main** method in **Module1** in Visual Basic), with the following code.</span></span> 
...
4. <span data-ttu-id="05c13-p146">选择 F5 键以调试解决方案。该程序完成运行后，选择任意键退出。</span><span class="sxs-lookup"><span data-stu-id="05c13-p146">Choose the F5 key to debug the solution. When the program has completed running, choose any key to exit.</span></span>
    
5. <span data-ttu-id="05c13-341">在 Visio 2013 中打开 Visio Package.vsdx 文件，然后选择**自定义**选项卡。</span><span class="sxs-lookup"><span data-stu-id="05c13-341">Open the Visio Package.vsdx file in Visio 2013, and then choose the **CUSTOM** tab.</span></span> 
    
<span data-ttu-id="05c13-342">自定义功能区类似于图 2 中，在 Visio 2013 中打开该文件时。</span><span class="sxs-lookup"><span data-stu-id="05c13-342">The custom ribbon looks like Figure 2 when the file is opened in Visio 2013.</span></span>
  
 <span data-ttu-id="05c13-343">**图 2。在 Visio 2013 功能区中的自定义选项卡**</span><span class="sxs-lookup"><span data-stu-id="05c13-343">**Figure 2. Custom tab in the Visio 2013 ribbon**</span></span>
  
![功能区中的自定义选项卡](media/vis15_CustomRibbonTab.PNG)
  
<span data-ttu-id="05c13-345">创建 XML`CreateCustomUI`方法如下所示。</span><span class="sxs-lookup"><span data-stu-id="05c13-345">The XML created by the  `CreateCustomUI` method looks like the following.</span></span> 
...
## <a name="acknowledgements"></a><span data-ttu-id="05c13-346">鸣谢</span><span class="sxs-lookup"><span data-stu-id="05c13-346">Acknowledgements</span></span>
<span data-ttu-id="05c13-347"><a name="vis15_ManipulateFF_Ackn"> </a></span><span class="sxs-lookup"><span data-stu-id="05c13-347"></span></span>

<span data-ttu-id="05c13-348">我们要识别的贡献和 Visio 的 MVP**所有 Edlund**创建本技术文章中包含的代码示例中的输入。</span><span class="sxs-lookup"><span data-stu-id="05c13-348">We would like to recognize the contribution and input of Visio MVP **Al Edlund** in creating the code examples contained in this technical article.</span></span> <span data-ttu-id="05c13-349">所有操作的 Visio 文件格式，包括 Visio XML 绘图格式 (.vdx) 和新的 Visio 文件格式 (.vsdx) 识别的专家。</span><span class="sxs-lookup"><span data-stu-id="05c13-349">Al is a recognized expert in manipulating the Visio file format, including both the Visio XML Drawing format (.vdx) and the new Visio file format (.vsdx).</span></span> <span data-ttu-id="05c13-350">所有创建了以编程方式浏览 Visio 文件格式的项目，并公开内的结构。</span><span class="sxs-lookup"><span data-stu-id="05c13-350">Al has created projects that explore the Visio file formats programmatically and exposes the structures inside.</span></span> 
  
<span data-ttu-id="05c13-351">有关所有的使用 Visio 文件格式的详细信息，请参阅后面的其他资源部分中的链接。</span><span class="sxs-lookup"><span data-stu-id="05c13-351">For more information about Al's work with the Visio file format, see the links in the Additional Resources section that follows.</span></span>
  
## <a name="see-also"></a><span data-ttu-id="05c13-352">另请参阅</span><span class="sxs-lookup"><span data-stu-id="05c13-352">See also</span></span>
<span data-ttu-id="05c13-353"><a name="vis15_ManipulateFF_Additional"> </a></span><span class="sxs-lookup"><span data-stu-id="05c13-353"></span></span>

- <span data-ttu-id="05c13-354">Al Edlund：</span><span class="sxs-lookup"><span data-stu-id="05c13-354">By Al Edlund:</span></span>
    
  - <span data-ttu-id="05c13-355">在 CodePlex 上的[pkgVisio-Visio 2013 XML 操作](http://pkgvisio.codeplex.com/documentation)项目。</span><span class="sxs-lookup"><span data-stu-id="05c13-355">[pkgVisio - Visio 2013 XML manipulation](http://pkgvisio.codeplex.com/documentation) project on CodePlex.</span></span> 
    
  - <span data-ttu-id="05c13-356">[pkgVisio_pt1](http://www.youtube.com/watch?v=7LvDKJuP9oQ&amp;feature=youtu.be) YouTube 上的视频。</span><span class="sxs-lookup"><span data-stu-id="05c13-356">[pkgVisio_pt1 ](http://www.youtube.com/watch?v=7LvDKJuP9oQ&amp;feature=youtu.be) video on YouTube.</span></span> 
    
  - <span data-ttu-id="05c13-357">[pkgVisio_pt2](http://www.youtube.com/watch?v=ZIWSXhNSkG8&amp;feature=youtu.be) YouTube 上的视频。</span><span class="sxs-lookup"><span data-stu-id="05c13-357">[pkgVisio_pt2 ](http://www.youtube.com/watch?v=ZIWSXhNSkG8&amp;feature=youtu.be) video on YouTube.</span></span> 
    
- [<span data-ttu-id="05c13-358">Visio 开发中心</span><span class="sxs-lookup"><span data-stu-id="05c13-358">Visio Developer Center</span></span>](http://msdn.microsoft.com/en-us/office/aa905478.aspx)
    
- [<span data-ttu-id="05c13-359">操作 Office Open XML 格式文档</span><span class="sxs-lookup"><span data-stu-id="05c13-359">Manipulate Office Open XML Formats Documents</span></span>](http://msdn.microsoft.com/en-us/library/aa982683%28v=office.12%29.aspx)
    
- [<span data-ttu-id="05c13-360">创建包含命名空间 (C#) (LINQ to XML) 的文档</span><span class="sxs-lookup"><span data-stu-id="05c13-360">Create a Document with Namespaces (C#) (LINQ to XML)</span></span>](http://msdn.microsoft.com/en-us/library/bb387075.aspx)
    
- [<span data-ttu-id="05c13-361">在不启动 Microsoft Office 的情况下向文档中添加自定义 XML 部件</span><span class="sxs-lookup"><span data-stu-id="05c13-361">Add Custom XML Parts to Documents Without Starting Microsoft Office</span></span>](http://msdn.microsoft.com/en-us/library/bb608597%28VS.90%29.aspx)
