...
|||
|:-----|:-----|
|**本文内容**         [Visio 文件格式操作基础知识](#vis15_ManipulateFF_Essentials)          [创建 .vsdx 文件和新的 Visual Studio 解决方案](#vis15_ManipulateFF_CreateFile)          [将 Visio 2013 文件作为包打开](#vis15_ManipulateFF_OpenPackage)          [从包中选择和读取包部件](#vis15_ManipulateFF_SelectPart)          [选择并更改包部件中的 XML 数据](#vis15_ManipulateFF_ChangeXML)          [重新计算文件中的数据](#vis15_ManipulateFF_Recalculate)          [向包中添加新的包部件](#vis15_ManipulateFF_AddNewPart)          [鸣谢](#vis15_ManipulateFF_Ackn)          [其他资源](#vis15_ManipulateFF_Additional)||
