...
例如，如果 Address 单元格，"Drawing1.vsdx"SubAddress 单元格可以指定一个页面名称，例如"第 3 页"。 如果 Address 单元格，Microsoft Excel 文件"Samples.xlsx"此单元格值可以是工作表或工作表，如"工作表函数"或"Sheet1 中范围 ！A1: D10"。 Address 单元格是否"https://www.microsoft.com/office/"，此单元格的值可以是在文档中，例如"解决方案"命名的定位。
