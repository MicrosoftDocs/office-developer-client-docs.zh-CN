...
---
# <a name="cell-element-ellipse-row-visio-xml"></a>Cell 元素 (Ellipse Row)  (Visio XML) 

包含椭圆的中心点和椭圆上的两个点的 x 坐标或 y 坐标。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Geometry (Row) ](row-element-geometry-sectionvisio-xml.md) <br/> |[Ellipse_Type](ellipse_type-complextypevisio-xml.md) <br/> |包含椭圆的中心点和椭圆上的两个点的 x 坐标或 y 坐标。  <br/> |
...
|A  <br/> |椭圆上第一个点的 x 坐标;与 B 单元格所代表的 y 坐标配对。  <br/> |[Ellipse Row (Geometry Section)](ellipse-row-geometry-section.md) <br/> |
|B  <br/> |椭圆上第一个点的 y 坐标;与由 A 单元格表示的 x 坐标配对。  <br/> |[Ellipse Row (Geometry Section)](ellipse-row-geometry-section.md) <br/> |
|C  <br/> |椭圆上第二个点的 x 坐标;与由 D 单元格表示的 y 坐标配对。  <br/> |[Ellipse Row (Geometry Section)](ellipse-row-geometry-section.md) <br/> |
|D  <br/> |椭圆上第二个点的 y 坐标;与 C 单元格表示的 y 坐标配对。  <br/> |[Ellipse Row (Geometry Section)](ellipse-row-geometry-section.md) <br/> |
