...
---
# <a name="cell-element-ellipse-row-visio-xml"></a>Cell 元素 ("椭圆形" 行) ("Visio XML")

包含椭圆中心点的 x 坐标或 y 坐标以及椭圆上的两个点。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Row 元素 ("几何")](row-element-geometry-sectionvisio-xml.md) <br/> |[Ellipse_Type](ellipse_type-complextypevisio-xml.md) <br/> |包含椭圆中心点的 x 坐标或 y 坐标以及椭圆上的两个点。  <br/> |
...
|A  <br/> |椭圆上第一个点的 x 坐标;与 B 单元格所表示的 y 坐标配对。  <br/> |[Ellipse Row (Geometry Section)](ellipse-row-geometry-section.md) <br/> |
|B  <br/> |椭圆上第一个点的 y 坐标;与 A 单元格所表示的 x 坐标配对。  <br/> |[Ellipse Row (Geometry Section)](ellipse-row-geometry-section.md) <br/> |
|C  <br/> |椭圆上第二个点的 x 坐标;与 D 单元格所表示的 y 坐标配对。  <br/> |[Ellipse Row (Geometry Section)](ellipse-row-geometry-section.md) <br/> |
|D  <br/> |椭圆上第二个点的 y 坐标;与 C 单元格所表示的 y 坐标配对。  <br/> |[Ellipse Row (Geometry Section)](ellipse-row-geometry-section.md) <br/> |
