...
---
# <a name="cell-element-polylineto-row-visio-xml"></a>Cell 元素 (PolyLineTo Row)  (Visio XML) 
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Geometry (Row) ](row-element-geometry-sectionvisio-xml.md) <br/> |[PolylineTo_Type](polylineto_type-complextypevisio-xml.md) <br/> |包含折线或折线公式的最后一个点的 x 坐标或 y 坐标。  <br/> |
...
|A  <br/> |折线公式。  <br/> |[PolylineTo Row (Geometry Section)](polylineto-row-geometry-section.md) <br/> |
