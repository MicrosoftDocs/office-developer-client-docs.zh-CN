...
---
# <a name="cell-element-geometry-section-visio-xml"></a>Cell 元素 ("Geometry" 内容) ("Visio XML")

定义用于确定格式和行为属性的属性, 这些属性与构成 "Geometry" 内容的线条和弧形相关。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Row 元素 ("几何")](row-element-geometry-sectionvisio-xml.md) <br/> |[Geometry_Type](geometry_type-complextypevisio-xml.md) <br/> |定义用于确定格式和行为属性的属性, 这些属性与构成 "Geometry" 内容的线条和弧形相关。  <br/> |
...
|NoQuickDrag  <br/> |确定当用户单击由 "Geometry" 内容定义的填充区域时, 是否可以选择或拖动形状。  <br/> |[NoQuickDrag 单元格 ("Geometry" 内容)](noquickdrag-cell-geometry-section.md) <br/> |
