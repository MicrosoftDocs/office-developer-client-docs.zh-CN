...
description: 确定草图效果是否以布尔值显示于形状上。
...
若要从另一个公式 **、Cell** 元素 **的 N** 属性值或使用 **CellsU** 属性从某个程序按名称获取对 **SketchEnabled** 单元格的引用，请使用： 
  
|||
|:-----|:-----|
| 单元格名称：  <br/> | SketchEnabled  <br/> |
   
若要从程序按索引获取对 **SketchEnabled** 单元格的引用，请使用带下列参数的 **CellsSRC** 属性： 
