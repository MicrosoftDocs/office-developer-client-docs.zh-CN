...
---
# <a name="row-element-connection-section-visio-xml"></a>Connection Section (XML)  (Visio 的 Row) 

包含形状上的单个连接点的 x 坐标或 y 坐标、水平和垂直方向以及类型。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |包含形状上的单个连接点的 x 坐标或 y 坐标、水平和垂直方向以及类型。  <br/> |
