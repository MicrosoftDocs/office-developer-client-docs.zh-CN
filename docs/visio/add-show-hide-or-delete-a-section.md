...
---
# <a name="add-show-hide-or-delete-a-section"></a>添加、 显示、 隐藏或删除内容
...
2. 执行以下操作之一：
  ...
  - 或者在 ShapeSheet 窗口中，右键单击，然后单击快捷菜单上的**插入节**。 
    
3. 选中要添加，部分的复选框，然后单击**确定**。
    
    > [!NOTE]
    >  如果您看不到在 ShapeSheet 窗口中的新建部分，确保部分设置为显示。 在**ShapeSheet 工具**选项卡上的**视图**组中，单击**各节**，然后选择想要显示的节对应的复选框。 
  
### <a name="to-show-or-hide-sections"></a>若要显示或隐藏内容

- 在您想要删除，部分中选择任意单元格，然后单击在**ShapeSheet 工具**选项卡上的**内容**组中的**删除**。
    
- 您可以右键单击单元格，然后单击快捷菜单上的**删除内容**。 
    
    > [!NOTE]
    >  无法删除某些部分。 例如，不能删除**Shape Transform**部分，因为它指定一个形状的位置。 如果您不能删除节，则**删除内容**不可用。 
