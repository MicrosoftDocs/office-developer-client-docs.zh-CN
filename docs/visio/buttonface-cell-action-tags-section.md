...
ButtonFace 单元格中包含的字符串表示 Microsoft Office 按钮外表图像的 ID。 值为 0 (零) 或空白默认为标准操作标记"i"信息按钮 ![标准操作标记"i"信息按钮](media/InfoPS_ZA10180114.gif).
...
|||
|:-----|:-----|
| 单元格名称：  <br/> | SmartTags。  *name*  .ButtonFace，其中 SmartTags。 *name*  是动作标记行的名称  <br/> |
