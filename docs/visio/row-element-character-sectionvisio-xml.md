...
---
# <a name="row-element-character-section-visio-xml"></a>Row 元素 ("字符" 部分) (Visio XML)

显示形状的文本局部的格式属性, 如字体、颜色、文本样式、大小写、相对于基线的位置以及磅值。
...
|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Section](section-element-sheet_type-complextypevisio-xml.md) <br/> |[Section_Type](section_type-complextypevisio-xml.md) <br/> |显示形状的文本局部的格式属性, 如字体、颜色、文本样式、大小写、相对于基线的位置以及磅值。  <br/> |
   
### <a name="child-elements"></a>子元素

|**元素**|**类型**|**说明**|
|:-----|:-----|:-----|
|[Cell](cell-element-character-sectionvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |指定一个属性。  <br/> |
